    ...
    public partial class AddressModelFactory : IAddressModelFactory
    {
            ...
            string overrideAttributesXml = "")
        {
            ...
            if (address == null && prePopulateWithCustomerFields)
            {
                ...
                model.Address1 = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.StreetAddressAttribute);
                model.Address2 = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.StreetAddress2Attribute);
                ...
                model.PhoneNumber = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.PhoneAttribute);
                model.FaxNumber = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.FaxAttribute);
            }
