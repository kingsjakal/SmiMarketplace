...
namespace Smi.Web.Factories
{
    public partial class CatalogModelFactory : ICatalogModelFactory
    {
        ...
        public virtual CategoryModel PrepareCategoryModel(Category category, CatalogPagingFilteringModel command)
        {
            ...
            model.SubCategories = _categoryService.GetAllCategoriesByParentCategoryId(category.Id)
                    .Select(curCategory =>
                    {
                        ...
                        var categoryPictureCacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.CategoryPictureModelKey, curCategory,
            ...
            if (!_catalogSettings.IgnoreFeaturedProducts)
            {
                ...
                var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.CategoryHasFeaturedProductsKey, category,
        ...
        public virtual List<CategoryModel> PrepareHomepageCategoryModels()
        {
            ...
            var categoriesCacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.CategoryHomepageKey, 
                pictureSize,
            ...
            var model = _staticCacheManager.Get(categoriesCacheKey, () =>
                _categoryService.GetAllCategoriesDisplayedOnHomepage()
                    .Select(category =>
                    {
                        ...
                        //prepare picture model
                        var categoryPictureCacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.CategoryPictureModelKey, 
        ...
        {
            //load and cache them
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.CategoryAllModelKey, 
                _workContext.WorkingLanguage,
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.CategoryXmlAllModelKey, 
                _workContext.WorkingLanguage,
                _customerService.GetCustomerRoleIds(_workContext.CurrentCustomer),
                _storeContext.CurrentStore);
        ...
        public virtual ManufacturerModel PrepareManufacturerModel(Manufacturer manufacturer, CatalogPagingFilteringModel command)
        {
            ...
            if (!_catalogSettings.IgnoreFeaturedProducts)
            {
                ...
                //We cache a value indicating whether we have featured products
                var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.ManufacturerHasFeaturedProductsKey, 
                    manufacturer,
                    _customerService.GetCustomerRoleIds(_workContext.CurrentCustomer),
                    _storeContext.CurrentStore);
                var hasFeaturedProductsCache = _staticCacheManager.Get(cacheKey, () =>
        ...
        public virtual List<ManufacturerModel> PrepareManufacturerAllModels()
        {
            ...
            foreach (var manufacturer in manufacturers)
            {
                ...
                var manufacturerPictureCacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.ManufacturerPictureModelKey, 
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.ManufacturerNavigationModelKey, 
        ...
        public virtual List<VendorModel> PrepareVendorAllModels()
        {
            ...
            foreach (var vendor in vendors)
            {
                ...
                var pictureCacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.VendorPictureModelKey, 
        ...
        {
            var cacheKey = SmiModelCacheDefaults.VendorNavigationModelKey;
            var cachedModel = _staticCacheManager.Get(cacheKey, () =>
            {
