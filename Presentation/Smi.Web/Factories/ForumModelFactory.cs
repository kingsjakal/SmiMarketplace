        ...
        public virtual ForumTopicPageModel PrepareForumTopicPageModel(ForumTopic forumTopic, int page)
        {
            ...
            foreach (var post in posts)
            {
                ...
                var forumPostModel = new ForumPostModel
                {
                    ...
                    ForumPostCount = _genericAttributeService.GetAttribute<Customer, int>(post.CustomerId, SmiCustomerDefaults.ForumPostCountAttribute),
                    ...
                    FormattedSignature = _forumService.FormatForumSignatureText(_genericAttributeService.GetAttribute<Customer, string>(post.CustomerId, SmiCustomerDefaults.SignatureAttribute)),
                };
                //created on string
                ...
                if (_customerSettings.AllowCustomersToUploadAvatars)
                {
                    forumPostModel.CustomerAvatarUrl = _pictureService.GetPictureUrl(
                        _genericAttributeService.GetAttribute<Customer, int>(post.CustomerId, SmiCustomerDefaults.AvatarPictureIdAttribute),
                ...
                {
                    var countryId = _genericAttributeService.GetAttribute<Customer, int>(post.CustomerId, SmiCustomerDefaults.CountryIdAttribute);
            ...
            string within, string limitDays, int page)
        {
            ...
            try
            {
                if (!string.IsNullOrWhiteSpace(searchterms))
                {
                    ...
                    {
                        throw new SmiException(string.Format(_localizationService.GetResource("Forum.SearchTermMinimumLengthIsNCharacters"),
