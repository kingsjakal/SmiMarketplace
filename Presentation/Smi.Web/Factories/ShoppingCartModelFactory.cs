...
namespace Smi.Web.Factories
{
    ...
    public partial class ShoppingCartModelFactory : IShoppingCartModelFactory
    {
        ...
        protected virtual ShoppingCartModel.OrderReviewDataModel PrepareOrderReviewDataModel(IList<ShoppingCartItem> cart)
        {
            ...
            if (_shoppingCartService.ShoppingCartRequiresShipping(cart))
            {
                ...
                var pickupPoint = _genericAttributeService.GetAttribute<PickupPoint>(_workContext.CurrentCustomer,
                    SmiCustomerDefaults.SelectedPickupPointAttribute, _storeContext.CurrentStore.Id);
                ...
                var shippingOption = _genericAttributeService.GetAttribute<ShippingOption>(_workContext.CurrentCustomer,
                    SmiCustomerDefaults.SelectedShippingOptionAttribute, _storeContext.CurrentStore.Id);
                if (shippingOption != null)
                    model.ShippingMethod = shippingOption.Name;
            }

            //payment info
            var selectedPaymentMethodSystemName = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer, SmiCustomerDefaults.SelectedPaymentMethodAttribute, _storeContext.CurrentStore.Id);
        ...
        {
            var pictureCacheKey = _cacheKeyService.PrepareKeyForShortTermCache(SmiModelCacheDefaults.CartPictureModelKey
        ...
        public virtual OrderTotalsModel PrepareOrderTotalsModel(IList<ShoppingCartItem> cart, bool isEditable)
        {
            ...
            if (cart.Any())
            {
                ...
                //payment method fee
                var paymentMethodSystemName = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer, SmiCustomerDefaults.SelectedPaymentMethodAttribute, _storeContext.CurrentStore.Id);
