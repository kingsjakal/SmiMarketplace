...
namespace Smi.Web.Factories
{
    ...
    public partial class NewsModelFactory : INewsModelFactory
    {
        ...
        public virtual NewsCommentModel PrepareNewsCommentModel(NewsComment newsComment)
        {
            ...
            if (_customerSettings.AllowCustomersToUploadAvatars)
            {
                model.CustomerAvatarUrl = _pictureService.GetPictureUrl(
                    _genericAttributeService.GetAttribute<Customer, int>(newsComment.CustomerId, SmiCustomerDefaults.AvatarPictureIdAttribute),
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.HomepageNewsModelKey, _workContext.WorkingLanguage, _storeContext.CurrentStore);
