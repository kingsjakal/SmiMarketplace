...
namespace Smi.Web.Factories
{
    ...
    public partial class BlogModelFactory : IBlogModelFactory
    {
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.BlogMonthsModelKey, _workContext.WorkingLanguage, _storeContext.CurrentStore);
