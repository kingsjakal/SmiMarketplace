...
namespace Smi.Web.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public virtual LogoModel PrepareLogoModel()
        {
            ...
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.StoreLogoPath
        ...
        public virtual HeaderLinksModel PrepareHeaderLinksModel()
        {
            ...
            if (unreadMessageCount > 0)
            {
                ...
                if (_forumSettings.ShowAlertForPM &&
                    !_genericAttributeService.GetAttribute<bool>(customer, SmiCustomerDefaults.NotifiedAboutNewPrivateMessagesAttribute, _storeContext.CurrentStore.Id))
                {
                    _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.NotifiedAboutNewPrivateMessagesAttribute, true, _storeContext.CurrentStore.Id);
        ...
        public virtual FooterModel PrepareFooterModel()
        {
            ...
            var model = new FooterModel
            {
                ...
                HidePoweredBySmiMarketplace = _storeInformationSettings.HidePoweredBySmiMarketplace,
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.SitemapPageModelKey, 
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.SitemapSeoModelKey, id,
                _workContext.WorkingLanguage,
                _customerService.GetCustomerRoleIds(_workContext.CurrentCustomer),
                _storeContext.CurrentStore);
