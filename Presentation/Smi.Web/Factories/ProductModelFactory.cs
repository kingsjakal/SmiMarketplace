...
namespace Smi.Web.Factories
{
    ...
    public partial class ProductModelFactory : IProductModelFactory
    {
        ...
        protected virtual ProductReviewOverviewModel PrepareProductReviewOverviewModel(Product product)
        {
            ...
            {
                var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.ProductReviewsModelKey, product, _storeContext.CurrentStore);
        ...
        protected virtual PictureModel PrepareProductOverviewPictureModel(Product product, int? productThumbPictureSize = null)
        {
            ...
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.ProductDefaultPictureModelKey, 
            ...
            foreach (var attribute in productAttributeMapping)
            {
                ...
                if (attribute.ShouldHaveValues())
                {
                    ...
                    foreach (var attributeValue in attributeValues)
                    {
                        ...
                        {
                            var productAttributeImageSquarePictureCacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.ProductAttributeImageSquarePictureModelKey
        ...
        protected virtual PictureModel PrepareProductDetailsPictureModel(Product product, bool isAssociatedProduct, out IList<PictureModel> allPictureModels)
        {
            ...
            var productPicturesCacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.ProductDetailsPicturesModelKey
