...
namespace Smi.Web.Factories
{
    ...
    public partial class PollModelFactory : IPollModelFactory
    {
        ...
        public virtual PollModel PreparePollModelBySystemName(string systemKeyword)
        {
            ...
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.PollBySystemNameModelKey, 
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.HomepagePollsModelKey, 
