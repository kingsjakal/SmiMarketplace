...
namespace Smi.Web.Models.ShoppingCart
{
    public partial class ShoppingCartModel : BaseSmiModel
    {
        ...
        public partial class CheckoutAttributeValueModel : BaseSmiEntityModel
        {
            public string Name { get; set; }
        ...
        public partial class DiscountBoxModel: BaseSmiModel
        {
            ...
            public class DiscountInfoModel : BaseSmiEntityModel
            {
                public string CouponCode { get; set; }
            }
        }

        public partial class GiftCardBoxModel : BaseSmiModel
        {
            public bool Display { get; set; }
        ...
        public partial class OrderReviewDataModel : BaseSmiModel
        {
