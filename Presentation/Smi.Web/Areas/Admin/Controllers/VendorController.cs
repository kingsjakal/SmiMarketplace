...
namespace Smi.Web.Areas.Admin.Controllers
{
    public partial class VendorController : BaseAdminController
    {
        ...
        protected virtual string ParseVendorAttributes(IFormCollection form)
        {
            ...
            {
                var controlId = $"{SmiVendorDefaults.VendorAttributePrefix}{attribute.Id}";
        ...
        public virtual IActionResult Create(VendorModel model, bool continueEditing, IFormCollection form)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //vendor attributes
                _genericAttributeService.SaveAttribute(vendor, SmiVendorDefaults.VendorAttributes, vendorAttributesXml);
