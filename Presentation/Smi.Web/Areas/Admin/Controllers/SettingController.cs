...
using Smi.Services.Media.RoxyFileman;
...
namespace Smi.Web.Areas.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
    {
        ...
        private readonly SmiConfig _config;
        ...
        public virtual IActionResult ChangeStoreScopeConfiguration(int storeid, string returnUrl = "")
        {
            ...
            if (store != null || storeid == 0)
            {
                _genericAttributeService
                    .SaveAttribute(_workContext.CurrentCustomer, SmiCustomerDefaults.AdminAreaStoreScopeConfigurationAttribute, storeid);
            }
        ...
        public virtual IActionResult ChangeEncryptionKey(GeneralCommonSettingsModel model)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(newEncryptionPrivateKey) || newEncryptionPrivateKey.Length != 16)
                    throw new SmiException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.EncryptionKey.TooShort"));

                var oldEncryptionPrivateKey = securitySettings.EncryptionKey;
                if (oldEncryptionPrivateKey == newEncryptionPrivateKey)
                    throw new SmiException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.EncryptionKey.TheSame"));
        ...
        public virtual IActionResult ToggleFullText(GeneralCommonSettingsModel model)
        {
            ...
            try
            {
                if (!_fulltextService.IsFullTextSupported())
                    throw new SmiException(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.FullTextSettings.NotSupported"));
            ...
            try
            {
                ...
                switch (_fileProvider.GetFileExtension(iconsFile.FileName))
                {
                    case ".ico":
                        ...
                        commonSettings.FaviconAndAppIconsHeadCode = string.Format(SmiCommonDefaults.SingleFaviconHeadLink, storeScope, iconsFile.FileName);
                    ...
                    case ".zip":
                        ...
                        var headCodePath = _fileProvider.GetAbsolutePath(string.Format(SmiCommonDefaults.FaviconAndAppIconsPath, storeScope), SmiCommonDefaults.HeadCodeFileName);
                        if (!_fileProvider.FileExists(headCodePath))
                            throw new Exception(string.Format(_localizationService.GetResource("Admin.Configuration.Settings.GeneralCommon.FaviconAndAppIcons.MissingFile"), SmiCommonDefaults.HeadCodeFileName));
                ...
                var oldFaviconIconPath = _fileProvider.GetAbsolutePath(string.Format(SmiCommonDefaults.OldFaviconIconName, storeScope));
