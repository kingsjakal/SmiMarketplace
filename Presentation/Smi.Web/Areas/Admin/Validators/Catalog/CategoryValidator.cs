...
{
    public partial class CategoryValidator : BaseSmiValidator<CategoryModel>
    {
        public CategoryValidator(ILocalizationService localizationService, ISmiDataProvider dataProvider)
        {
