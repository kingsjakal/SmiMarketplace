...
using Smi.Web.Areas.Admin.Models.Affiliates;
using Smi.Web.Areas.Admin.Models.Blogs;
using Smi.Web.Areas.Admin.Models.Catalog;
using Smi.Web.Areas.Admin.Models.Cms;
...
namespace Smi.Web.Areas.Admin.Infrastructure.Mapper
{
    /// <summary>
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        public AdminMapperConfiguration()
        {
            ...
            {
                //exclude Form and CustomProperties from mapping BaseSmiModel
                if (typeof(BaseSmiModel).IsAssignableFrom(mapConfiguration.DestinationType))
                {
                    //map.ForMember(nameof(BaseSmiModel.Form), options => options.Ignore());
                    map.ForMember(nameof(BaseSmiModel.CustomProperties), options => options.Ignore());
                }
