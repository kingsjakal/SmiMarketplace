...
namespace Smi.Web.Areas.Admin.Infrastructure.Mapper.Extensions
{
    /// <summary>
    ...
    public static class MappingExtensions
    {
        ...
        public static TModel ToModel<TModel>(this BaseEntity entity) where TModel : BaseSmiEntityModel
        {
            if (entity == null)
        ...
        public static TModel ToModel<TEntity, TModel>(this TEntity entity, TModel model) 
            where TEntity : BaseEntity where TModel : BaseSmiEntityModel
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        public static TEntity ToEntity<TEntity>(this BaseSmiEntityModel model) where TEntity : BaseEntity
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToSettingsModel<TModel>(this ISettings settings) where TModel : BaseSmiModel, ISettingsModel
        {
            if (settings == null)
        ...
        public static TSettings ToSettings<TSettings, TModel>(this TModel model, TSettings settings)
            where TSettings : class, ISettings where TModel : BaseSmiModel, ISettingsModel
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        /// <returns>Mapped model</returns>
        public static TModel ToPluginModel<TModel>(this IPlugin plugin) where TModel : BaseSmiModel, IPluginModel
        {
            if (plugin == null)
        ...
        public static TModel ToPluginModel<TModel>(this PluginDescriptor pluginDescriptor, TModel model = null) 
            where TModel : BaseSmiModel, IPluginModel
        {
