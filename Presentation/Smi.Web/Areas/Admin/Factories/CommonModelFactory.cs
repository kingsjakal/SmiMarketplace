...
using Smi.Web.Framework.Security;
...
namespace Smi.Web.Areas.Admin.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        private readonly SmiConfig _SmiConfig;
        ...
        protected virtual void PrepareRemovalKeyWarningModel(IList<SystemWarningModel> models)
        {
            ...
            try
            {
                warning = _SmiHttpClient.GetCopyrightWarningAsync().Result;
            }
            catch { }
        ...
        public virtual SystemInfoModel PrepareSystemInfoModel(SystemInfoModel model)
        {
            ...
            model.SmiVersion = SmiVersion.CurrentVersion;
            ...
            model.RedisEnabled = _SmiConfig.RedisEnabled;
            model.UseRedisToStoreDataProtectionKeys = _SmiConfig.UseRedisToStoreDataProtectionKeys;
            model.UseRedisForCaching = _SmiConfig.UseRedisForCaching;
            model.UseRedisToStorePluginsInfo = _SmiConfig.UseRedisToStorePluginsInfo;

            model.AzureBlobStorageEnabled = _SmiConfig.AzureBlobStorageEnabled;
        ...
        public virtual CommonStatisticsModel PrepareCommonStatisticsModel()
        {
            ...
            var customerRoleIds = new[] { _customerService.GetCustomerRoleBySystemName(SmiCustomerDefaults.RegisteredRoleName).Id };
