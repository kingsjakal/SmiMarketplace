...
namespace Smi.Web.Areas.Admin.Factories
{
    ...
    public partial class BaseAdminModelFactory : IBaseAdminModelFactory
    {
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.CategoriesListKey, showHidden);
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.ManufacturersListKey, showHidden);
            var listItems = _staticCacheManager.Get(cacheKey, () =>
            {
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.VendorsListKey, showHidden);
            var listItems = _staticCacheManager.Get(cacheKey, () =>
            {
