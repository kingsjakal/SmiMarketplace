...
namespace Smi.Web.Areas.Admin.Factories
{
    ...
    public partial class PluginModelFactory : IPluginModelFactory
    {
        ...
        public virtual OfficialFeedPluginSearchModel PrepareOfficialFeedPluginSearchModel(OfficialFeedPluginSearchModel searchModel)
        {
            ...
            var currentVersionItem = searchModel.AvailableVersions.FirstOrDefault(x => x.Text.Contains(SmiVersion.CurrentVersion));
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiPluginDefaults.AdminNavigationPluginsCacheKey, _workContext.CurrentCustomer);
