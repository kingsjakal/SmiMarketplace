...
namespace Smi.Web.Areas.Admin.Models.ShoppingCart
{
    ...
    public partial class ShoppingCartSearchModel : BaseSearchModel
    {
        ...
        [SmiResourceDisplayName("Admin.ShoppingCartType.StartDate")]
        [UIHint("DateNullable")]
        public DateTime? StartDate { get; set; }

        [SmiResourceDisplayName("Admin.ShoppingCartType.EndDate")]
        [UIHint("DateNullable")]
        public DateTime? EndDate { get; set; }

        [SmiResourceDisplayName("Admin.ShoppingCartType.Product")]
        public int ProductId { get; set; }

        [SmiResourceDisplayName("Admin.ShoppingCartType.BillingCountry")]
        public int BillingCountryId { get; set; }

        [SmiResourceDisplayName("Admin.ShoppingCartType.Store")]
