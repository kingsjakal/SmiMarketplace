...
namespace Smi.Web.Areas.Admin.Models.Orders
{
    ...
    public partial class GiftCardSearchModel : BaseSearchModel
    {
        ...
        [SmiResourceDisplayName("Admin.GiftCards.List.CouponCode")]
        public string CouponCode { get; set; }

        [SmiResourceDisplayName("Admin.GiftCards.List.RecipientName")]
        public string RecipientName { get; set; }

        [SmiResourceDisplayName("Admin.GiftCards.List.Activated")]
