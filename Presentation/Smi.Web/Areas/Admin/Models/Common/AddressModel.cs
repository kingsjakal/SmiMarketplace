...
namespace Smi.Web.Areas.Admin.Models.Common
{
    public partial class AddressModel : BaseSmiEntityModel
    {
        ...
        [SmiResourceDisplayName("Admin.Address.Fields.FirstName")]
        public string FirstName { get; set; }

        [SmiResourceDisplayName("Admin.Address.Fields.LastName")]
        public string LastName { get; set; }

        [DataType(DataType.EmailAddress)]
        [SmiResourceDisplayName("Admin.Address.Fields.Email")]
        public string Email { get; set; }

        [SmiResourceDisplayName("Admin.Address.Fields.Company")]
        ...
        [SmiResourceDisplayName("Admin.Address.Fields.Address2")]
        ...
        [SmiResourceDisplayName("Admin.Address.Fields.PhoneNumber")]
        public string PhoneNumber { get; set; }

        [SmiResourceDisplayName("Admin.Address.Fields.FaxNumber")]
        public string FaxNumber { get; set; }

        //address in HTML format (usually used in grids)
        [SmiResourceDisplayName("Admin.Address")]
