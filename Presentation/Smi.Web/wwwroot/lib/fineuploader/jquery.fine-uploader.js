...
(function(global) {
    (function($) {
        "use strict";
        var $el, plugiSmitions = [ "uploaderType", "endpointType" ];
        ...
        function getNewUploaderInstance(params) {
            var uploaderType = plugiSmition("uploaderType"), namespace = plugiSmition("endpointType");
            if (uploaderType) {
        ...
        function plugiSmition(option, optionVal) {
        ...
        function transformVariables(source, dest) {
            ...
            $.each(source, function(prop, val) {
                if ($.inArray(prop, plugiSmitions) >= 0) {
                    plugiSmition(prop, val);
    ...
    (function() {
        ...
        qq.basePrivateApi = {
            ...
            _generateExtraButtonSpecs: function() {
                ...
                qq.each(this._options.extraButtons, function(idx, extraButtoSmitionEntry) {
                    var multiple = extraButtoSmitionEntry.multiple, validation = qq.extend({}, self._options.validation, true), extraButtonSpec = qq.extend({}, extraButtoSmitionEntry);
                    if (multiple === undefined) {
                        multiple = self._options.multiple;
                    }
                    if (extraButtonSpec.validation) {
                        qq.extend(validation, extraButtoSmitionEntry.validation, true);
                    }
    ...
    qq.ExifRestorer = function() {
        var ExifRestorer = {};
        ExifRestorer.KEY_STR = "ABCDEFGHIJKLMSmi" + "QRSTUVWXYZabcdef" + "ghijklmSmiqrstuv" + "wxyz0123456789+/" + "=";
