...
namespace Smi.Web.Controllers
{
    ...
    public partial class ShoppingCartController : BasePublicController
    {
        ...
        protected virtual void ParseAndSaveCheckoutAttributes(IList<ShoppingCartItem> cart, IFormCollection form)
        {
            ...
            _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, SmiCustomerDefaults.CheckoutAttributes, attributesXml, _storeContext.CurrentStore.Id);
        }
        ...
        public virtual IActionResult SelectShippingOption([FromQuery]string name, [FromQuery]EstimateShippingModel model, IFormCollection form)
        {
            ...
            _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                SmiCustomerDefaults.SelectedShippingOptionAttribute, selectedShippingOption, _storeContext.CurrentStore.Id);
            ...
            bool loadPicture, IFormCollection form)
        {
            ...
            if (loadPicture)
            {
                ...
                if (pictureId > 0)
                {
                    var productAttributePictureCacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiModelCacheDefaults.ProductAttributePictureModelKey, 
        ...
        {
            var returnUrl = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer, SmiCustomerDefaults.LastContinueShoppingPageAttribute, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult GetEstimateShipping(EstimateShippingModel model, IFormCollection form)
        {
            ...
            if (result?.ShippingOptions?.Any() == true)
            {
                ...
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                    SmiCustomerDefaults.OfferedShippingOptionsAttribute, options, _storeContext.CurrentStore.Id);
            }
