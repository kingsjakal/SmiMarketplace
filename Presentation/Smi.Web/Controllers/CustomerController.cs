...
using Smi.Services.ExportImport;
...
namespace Smi.Web.Controllers
{
    ...
    public partial class CustomerController : BasePublicController
    {
        ...
        protected virtual string ParseCustomCustomerAttributes(IFormCollection form)
        {
            ...
            {
                var controlId = $"{SmiCustomerServicesDefaults.CustomerAttributePrefix}{attribute.Id}";
        ...
        public virtual IActionResult Logout()
        {
            if (_workContext.OriginalCustomerIfImpersonated != null)
            {
                ...
                _genericAttributeService
                    .SaveAttribute<int?>(_workContext.OriginalCustomerIfImpersonated, SmiCustomerDefaults.ImpersonatedCustomerIdAttribute, null);
            ...
            if (_storeInformationSettings.DisplayEuCookieLawWarning)
            {
                ...
                TempData[$"{SmiCookieDefaults.Prefix}{SmiCookieDefaults.IgnoreEuCookieLawWarning}"] = true;
            }
        ...
        public virtual IActionResult PasswordRecoverySend(PasswordRecoveryModel model, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (customer != null && customer.Active && !customer.Deleted)
                {
                    ...
                    _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.PasswordRecoveryTokenAttribute,
                        passwordRecoveryToken.ToString());
                    DateTime? generatedDateTime = DateTime.UtcNow;
                    _genericAttributeService.SaveAttribute(customer,
                        SmiCustomerDefaults.PasswordRecoveryTokenDateGeneratedAttribute, generatedDateTime);
        ...
        public virtual IActionResult PasswordRecoveryConfirm(string token, string email, Guid guid)
        {
            ...
            if (string.IsNullOrEmpty(_genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.PasswordRecoveryTokenAttribute)))
            {
        ...
        public virtual IActionResult Register(RegisterModel model, string returnUrl, bool captchaValid, IFormCollection form)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (registrationResult.Success)
                {
                    ...
                    {
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.TimeZoneIdAttribute, model.TimeZoneId);
                    }
                    //VAT number
                    if (_taxSettings.EuVatEnabled)
                    {
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.VatNumberAttribute, model.VatNumber);

                        var vatNumberStatus = _taxService.GetVatNumberStatus(model.VatNumber, out _, out var vatAddress);
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.VatNumberStatusIdAttribute, (int)vatNumberStatus);
                    ...
                    if (_customerSettings.GenderEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.GenderAttribute, model.Gender);
                    if (_customerSettings.FirstNameEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.FirstNameAttribute, model.FirstName);
                    if (_customerSettings.LastNameEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.LastNameAttribute, model.LastName);
                    if (_customerSettings.DateOfBirthEnabled)
                    {
                        var dateOfBirth = model.ParseDateOfBirth();
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.DateOfBirthAttribute, dateOfBirth);
                    }
                    if (_customerSettings.CompanyEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.CompanyAttribute, model.Company);
                    if (_customerSettings.StreetAddressEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.StreetAddressAttribute, model.StreetAddress);
                    if (_customerSettings.StreetAddress2Enabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.StreetAddress2Attribute, model.StreetAddress2);
                    if (_customerSettings.ZipPostalCodeEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.ZipPostalCodeAttribute, model.ZipPostalCode);
                    if (_customerSettings.CityEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.CityAttribute, model.City);
                    if (_customerSettings.CountyEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.CountyAttribute, model.County);
                    if (_customerSettings.CountryEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.CountryIdAttribute, model.CountryId);
                    if (_customerSettings.CountryEnabled && _customerSettings.StateProvinceEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.StateProvinceIdAttribute,
                            model.StateProvinceId);
                    if (_customerSettings.PhoneEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.PhoneAttribute, model.Phone);
                    if (_customerSettings.FaxEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.FaxAttribute, model.Fax);
                    ...
                    _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.CustomCustomerAttributes, customerAttributesXml);
                    ...
                    {
                        FirstName = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.FirstNameAttribute),
                        LastName = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.LastNameAttribute),
                        Email = customer.Email,
                        Company = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.CompanyAttribute),
                        CountryId = _genericAttributeService.GetAttribute<int>(customer, SmiCustomerDefaults.CountryIdAttribute) > 0
                            ? (int?)_genericAttributeService.GetAttribute<int>(customer, SmiCustomerDefaults.CountryIdAttribute)
                            : null,
                        StateProvinceId = _genericAttributeService.GetAttribute<int>(customer, SmiCustomerDefaults.StateProvinceIdAttribute) > 0
                            ? (int?)_genericAttributeService.GetAttribute<int>(customer, SmiCustomerDefaults.StateProvinceIdAttribute)
                            : null,
                        County = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.CountyAttribute),
                        City = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.CityAttribute),
                        Address1 = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.StreetAddressAttribute),
                        Address2 = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.StreetAddress2Attribute),
                        ZipPostalCode = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.ZipPostalCodeAttribute),
                        PhoneNumber = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.PhoneAttribute),
                        FaxNumber = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.FaxAttribute),
                        ...
                        case UserRegistrationType.EmailValidation:
                            {
                                ...
                                _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.AccountActivationTokenAttribute, Guid.NewGuid().ToString());
        ...
        public virtual IActionResult AccountActivation(string token, string email, Guid guid)
        {
            ...
            var cToken = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.AccountActivationTokenAttribute);
            ...
            _customerService.UpdateCustomer(customer);
            _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.AccountActivationTokenAttribute, "");
        ...
        public virtual IActionResult Info(CustomerInfoModel model, IFormCollection form)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (_dateTimeSettings.AllowCustomersToSetTimeZone)
                    {
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.TimeZoneIdAttribute,
                            model.TimeZoneId);
                    }
                    //VAT number
                    if (_taxSettings.EuVatEnabled)
                    {
                        var prevVatNumber = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.VatNumberAttribute);

                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.VatNumberAttribute,
                            model.VatNumber);
                    ...
                    if (_customerSettings.CountryEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.CountryIdAttribute, model.CountryId);
                    if (_customerSettings.CountryEnabled && _customerSettings.StateProvinceEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.StateProvinceIdAttribute, model.StateProvinceId);
                    if (_customerSettings.PhoneEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.PhoneAttribute, model.Phone);
                    if (_customerSettings.FaxEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.FaxAttribute, model.Fax);
                    ...
                    if (_forumSettings.ForumsEnabled && _forumSettings.SignaturesEnabled)
                        _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.SignatureAttribute, model.Signature);

                    //save customer attributes
                    _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                        SmiCustomerDefaults.CustomCustomerAttributes, customerAttributesXml);
        ...
        public virtual IActionResult EmailRevalidation(string token, string email, Guid guid)
        {
            ...
            var cToken = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.EmailRevalidationTokenAttribute);
            if (string.IsNullOrEmpty(cToken))
            ...
            _customerService.UpdateCustomer(customer);
            _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.EmailRevalidationTokenAttribute, "");
        ...
        public virtual IActionResult UploadAvatar(CustomerAvatarModel model, IFormFile uploadedFile)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    var customerAvatar = _pictureService.GetPictureById(_genericAttributeService.GetAttribute<int>(customer, SmiCustomerDefaults.AvatarPictureIdAttribute));
                    if (uploadedFile != null && !string.IsNullOrEmpty(uploadedFile.FileName))
                    {
                        var avatarMaxSize = _customerSettings.AvatarMaximumSizeBytes;
                        if (uploadedFile.Length > avatarMaxSize)
                            throw new SmiException(string.Format(_localizationService.GetResource("Account.Avatar.MaximumUploadedFileSize"), avatarMaxSize));
                    ...
                    _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.AvatarPictureIdAttribute, customerAvatarId);
        ...
        public virtual IActionResult RemoveAvatar(CustomerAvatarModel model)
        {
            ...
            _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.AvatarPictureIdAttribute, 0);
