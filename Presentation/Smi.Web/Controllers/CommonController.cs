...
namespace Smi.Web.Controllers
{
    ...
    public partial class CommonController : BasePublicController
    {
        ...
        public virtual IActionResult EuCookieLawAccept()
        {
            ...
            //save setting
            _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, SmiCustomerDefaults.EuCookieLawAcceptedAttribute, true, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult InternalRedirect(string url, bool permanentRedirect)
        {
            ...
            if (HttpContext.Items["Smi.RedirectFromGenericPathRoute"] == null ||
                !Convert.ToBoolean(HttpContext.Items["Smi.RedirectFromGenericPathRoute"]))
            {
