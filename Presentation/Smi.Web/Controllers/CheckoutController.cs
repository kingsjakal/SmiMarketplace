...
namespace Smi.Web.Controllers
{
    ...
    public partial class CheckoutController : BasePublicController
    {
        ...
        protected virtual void SavePickupOption(PickupPoint pickupPoint)
        {
            ...
            _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, SmiCustomerDefaults.SelectedShippingOptionAttribute, pickUpInStoreShippingOption, _storeContext.CurrentStore.Id);
            _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, SmiCustomerDefaults.SelectedPickupPointAttribute, pickupPoint, _storeContext.CurrentStore.Id);
        }
        ...
        public virtual IActionResult Index()
        {
            ...
            var checkoutAttributesXml = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer,
                SmiCustomerDefaults.CheckoutAttributes, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult SelectBillingAddress(int addressId, bool shipToSameAddress = false)
        {
            ...
            if (_shippingSettings.ShipToSameAddress && shipToSameAddress && _shoppingCartService.ShoppingCartRequiresShipping(cart) && shippingAllowed)
            {
                ...
                _genericAttributeService.SaveAttribute<ShippingOption>(_workContext.CurrentCustomer, SmiCustomerDefaults.SelectedShippingOptionAttribute, null, _storeContext.CurrentStore.Id);
                _genericAttributeService.SaveAttribute<PickupPoint>(_workContext.CurrentCustomer, SmiCustomerDefaults.SelectedPickupPointAttribute, null, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult ShippingMethod()
        {
                ...
                model.ShippingMethods.Count == 1)
            {
                ...
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                    SmiCustomerDefaults.SelectedShippingOptionAttribute,
        ...
        public virtual IActionResult SelectShippingMethod(string shippingoption, IFormCollection form)
        {
            ...
            if (!_shoppingCartService.ShoppingCartRequiresShipping(cart))
            {
                _genericAttributeService.SaveAttribute<ShippingOption>(_workContext.CurrentCustomer,
                    SmiCustomerDefaults.SelectedShippingOptionAttribute, null, _storeContext.CurrentStore.Id);
                return RedirectToRoute("CheckoutPaymentMethod");
            }
            ...
            var shippingOptions = _genericAttributeService.GetAttribute<List<ShippingOption>>(_workContext.CurrentCustomer,
                SmiCustomerDefaults.OfferedShippingOptionsAttribute, _storeContext.CurrentStore.Id);
            ...
            //save
            _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, SmiCustomerDefaults.SelectedShippingOptionAttribute, shippingOption, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult PaymentMethod()
        {
            ...
            if (!isPaymentWorkflowRequired)
            {
                _genericAttributeService.SaveAttribute<string>(_workContext.CurrentCustomer,
                    SmiCustomerDefaults.SelectedPaymentMethodAttribute, null, _storeContext.CurrentStore.Id);
                ...
                paymentMethodModel.PaymentMethods.Count == 1 && !paymentMethodModel.DisplayRewardPoints)
            {
                ...
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                    SmiCustomerDefaults.SelectedPaymentMethodAttribute,
        ...
        public virtual IActionResult SelectPaymentMethod(string paymentmethod, CheckoutPaymentMethodModel model)
        {
            ...
            {
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                    SmiCustomerDefaults.UseRewardPointsDuringCheckoutAttribute, model.UseRewardPoints,
                    _storeContext.CurrentStore.Id);
            }
            ...
            //save
            _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                SmiCustomerDefaults.SelectedPaymentMethodAttribute, paymentmethod, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult PaymentInfo()
        {
            ...
            var paymentMethodSystemName = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer,
                SmiCustomerDefaults.SelectedPaymentMethodAttribute, _storeContext.CurrentStore.Id);
