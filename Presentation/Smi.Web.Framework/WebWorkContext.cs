...
namespace Smi.Web.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        /// <summary>
        /// Get Smi customer cookie
        /// </summary>
        /// <returns>String value of cookie</returns>
        protected virtual string GetCustomerCookie()
        {
            var cookieName = $"{SmiCookieDefaults.Prefix}{SmiCookieDefaults.CustomerCookie}";
            return _httpContextAccessor.HttpContext?.Request?.Cookies[cookieName];
        }

        /// <summary>
        /// Set Smi customer cookie
        /// </summary>
        ...
        public virtual Customer CurrentCustomer
        {
            get
            {
                ...
                if (_httpContextAccessor.HttpContext == null ||
                    _httpContextAccessor.HttpContext.Request.Path.Equals(new PathString($"/{SmiTaskDefaults.ScheduleTaskPath}"), StringComparison.InvariantCultureIgnoreCase))
                {
                ...
                if (customer != null && !customer.Deleted && customer.Active && !customer.RequireReLogin)
                {
                    ...
                    var impersonatedCustomerId = _genericAttributeService
                        .GetAttribute<int?>(customer, SmiCustomerDefaults.ImpersonatedCustomerIdAttribute);
        ...
        public virtual Language WorkingLanguage
        {
            get
            {
                ...
                if (detectedLanguage == null && _localizationSettings.AutomaticallyDetectLanguage)
                {
                    ...
                    var alreadyDetected = _genericAttributeService.GetAttribute<bool>(CurrentCustomer,
                        SmiCustomerDefaults.LanguageAutomaticallyDetectedAttribute, _storeContext.CurrentStore.Id);
                    ...
                    if (!alreadyDetected)
                    {
                        ...
                        if (detectedLanguage != null)
                        {
                            ...
                            _genericAttributeService.SaveAttribute(CurrentCustomer,
                                SmiCustomerDefaults.LanguageAutomaticallyDetectedAttribute, true, _storeContext.CurrentStore.Id);
                        }
                    }
                }
                ...
                if (detectedLanguage != null)
                {
                    ...
                    var currentLanguageId = _genericAttributeService.GetAttribute<int>(CurrentCustomer,
                        SmiCustomerDefaults.LanguageIdAttribute, _storeContext.CurrentStore.Id);

                    //save the detected language identifier if it differs from the current one
                    if (detectedLanguage.Id != currentLanguageId)
                    {
                        _genericAttributeService.SaveAttribute(CurrentCustomer,
                            SmiCustomerDefaults.LanguageIdAttribute, detectedLanguage.Id, _storeContext.CurrentStore.Id);
                    }
                }
            ...
            set
            {
                ...
                //and save it
                _genericAttributeService.SaveAttribute(CurrentCustomer,
                    SmiCustomerDefaults.LanguageIdAttribute, languageId, _storeContext.CurrentStore.Id);
        ...
        public virtual Currency WorkingCurrency
        {
            get
            {
                ...
                var customerCurrencyId = _genericAttributeService.GetAttribute<int>(CurrentCustomer,
                    SmiCustomerDefaults.CurrencyIdAttribute, _storeContext.CurrentStore.Id);
            ...
            set
            {
                ...
                //and save it
                _genericAttributeService.SaveAttribute(CurrentCustomer,
                    SmiCustomerDefaults.CurrencyIdAttribute, currencyId, _storeContext.CurrentStore.Id);
        ...
        public virtual TaxDisplayType TaxDisplayType
        {
            get
            {
                ...
                if (_taxSettings.AllowCustomersToSelectTaxDisplayType && CurrentCustomer != null)
                {
                    ...
                    var taxDisplayTypeId = _genericAttributeService.GetAttribute<int?>(CurrentCustomer,
                        SmiCustomerDefaults.TaxDisplayTypeIdAttribute, _storeContext.CurrentStore.Id);
            ...
            set
            {
                ...
                //save passed value
                _genericAttributeService.SaveAttribute(CurrentCustomer,
                    SmiCustomerDefaults.TaxDisplayTypeIdAttribute, (int)value, _storeContext.CurrentStore.Id);
