...
namespace Smi.Web.Framework.Infrastructure
{
    ...
    /// </summary>
    public class SmiCommonStartup : ISmiStartup
    {
        /// <summary>
        ...
        public void Configure(IApplicationBuilder application)
        {
            ...
            application.UseSmiResponseCompression();

            //use static files feature
            application.UseSmiStaticFiles();
            ...
            application.UseSmiRequestLocalization();
