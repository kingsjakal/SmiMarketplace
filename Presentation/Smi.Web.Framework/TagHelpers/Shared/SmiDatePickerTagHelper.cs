...
{
    /// <summary>
    /// Smi-date-picker tag helper
    /// </summary>
    [HtmlTargetElement("Smi-date-picker", 
        Attributes = DayNameAttributeName + "," + MonthNameAttributeName + "," + YearNameAttributeName, 
        TagStructure = TagStructure.WithoutEndTag)]
    public class SmiDatePickerTagHelper : TagHelper
    {
        ...
        public SmiDatePickerTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
