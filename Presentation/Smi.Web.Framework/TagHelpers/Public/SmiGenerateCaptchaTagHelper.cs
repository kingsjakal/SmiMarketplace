...
{
    /// <summary>
    /// Smi-captcha tag helper
    /// </summary>
    [HtmlTargetElement("Smi-captcha", TagStructure = TagStructure.WithoutEndTag)]
    public class SmiGenerateCaptchaTagHelper : TagHelper
    {
        ...
        public SmiGenerateCaptchaTagHelper(IHtmlHelper htmlHelper, CaptchaSettings captchaSettings)
        {
