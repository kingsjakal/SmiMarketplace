...
namespace Smi.Web.Framework.TagHelpers.Public
{
    /// <summary>
    /// Smi-bb-code-editor tag helper
    /// </summary>
    [HtmlTargetElement("Smi-bb-code-editor", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class SmiBBCodeEditorTagHelper : TagHelper
    {
        ...
        public SmiBBCodeEditorTagHelper(IWebHelper webHelper)
        {
