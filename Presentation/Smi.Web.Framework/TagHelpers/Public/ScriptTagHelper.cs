...
namespace Smi.Web.Framework.TagHelpers.Public
{
    ...
    public class ScriptTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (_httpContextAccessor.HttpContext.Items["Smi.IgnoreScriptTagLocation"] != null &&
                Convert.ToBoolean(_httpContextAccessor.HttpContext.Items["Smi.IgnoreScriptTagLocation"]))
                return;
