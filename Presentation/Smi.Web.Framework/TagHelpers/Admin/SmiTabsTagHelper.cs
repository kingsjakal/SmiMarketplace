...
namespace Smi.Web.Framework.TagHelpers.Admin
{
    ...
    /// Smi-tabs tag helper
    /// </summary>
    [HtmlTargetElement("Smi-tabs", Attributes = IdAttributeName)]
    public class SmiTabsTagHelper : TagHelper
    {
        ...
        public SmiTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //create context item
            var tabContext = new List<SmiTabContextItem>();
            context.Items.Add(typeof(SmiTabsTagHelper), tabContext);
    ...
    /// "Smi-tab tag helper
    /// </summary>
    [HtmlTargetElement("Smi-tab", ParentTag = "Smi-tabs", Attributes = NameAttributeName)]
    public class SmiTabTagHelper : TagHelper
    {
        ...
        /// </summary>
        /// <param name="htmlHelper">HTML helper</param>
        public SmiTabTagHelper(IHtmlHelper htmlHelper)
        {
            _htmlHelper = htmlHelper;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<SmiTabContextItem>)context.Items[typeof(SmiTabsTagHelper)];
            tabContext.Add(new SmiTabContextItem()
            {
    ...
    /// Tab context item
    /// </summary>
    public class SmiTabContextItem
    {
        /// <summary>
        /// Title
        /// </summary>
