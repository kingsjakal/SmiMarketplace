...
{
    /// <summary>
    /// Smi-editor tag helper
    /// </summary>
    [HtmlTargetElement("Smi-editor", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class SmiEditorTagHelper : TagHelper
    {
        ...
        public SmiEditorTagHelper(IHtmlHelper htmlHelper)
        {
