...
{
    /// <summary>
    /// Smi-textarea tag helper
    /// </summary>
    [HtmlTargetElement("Smi-textarea", Attributes = ForAttributeName)]
    public class SmiTextAreaTagHelper : TextAreaTagHelper
    {
        ...
        public SmiTextAreaTagHelper(IHtmlGenerator generator) : base(generator)
        {
        }
