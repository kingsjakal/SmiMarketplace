...
{
    /// <summary>
    /// Smi-select tag helper
    /// </summary>
    [HtmlTargetElement("Smi-select", TagStructure = TagStructure.WithoutEndTag)]
    public class SmiSelectTagHelper : TagHelper
    {
        ...
        public SmiSelectTagHelper(IHtmlHelper htmlHelper)
        {
