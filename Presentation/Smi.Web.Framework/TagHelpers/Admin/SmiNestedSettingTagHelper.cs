...
{
    /// <summary>
    /// Smi-nested-setting tag helper
    /// </summary>
    [HtmlTargetElement("Smi-nested-setting", Attributes = ForAttributeName)]
    public class SmiNestedSettingTagHelper : TagHelper
    {
        ...
        public SmiNestedSettingTagHelper(IHtmlGenerator generator)
        {
            Generator = generator;
        }
