...
{
    /// <summary>
    /// Smi-action-confirmation tag helper
    /// </summary>
    [HtmlTargetElement("Smi-action-confirmation", Attributes = ButtonIdAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class SmiActionConfirmationTagHelper : TagHelper
    {
        ...
        public SmiActionConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
