...
{
    /// <summary>
    /// Smi-delete-confirmation tag helper
    /// </summary>
    [HtmlTargetElement("Smi-delete-confirmation", Attributes = ModelIdAttributeName + "," + ButtonIdAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class SmiDeleteConfirmationTagHelper : TagHelper
    {
        ...
        public SmiDeleteConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
