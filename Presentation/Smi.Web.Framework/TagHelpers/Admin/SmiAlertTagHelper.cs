...
{
    /// <summary>
    /// Smi-alert tag helper
    /// </summary>
    [HtmlTargetElement("Smi-alert", Attributes = AlertNameId, TagStructure = TagStructure.WithoutEndTag)]
    public class SmiAlertTagHelper : TagHelper
    {
        ...
        public SmiAlertTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
