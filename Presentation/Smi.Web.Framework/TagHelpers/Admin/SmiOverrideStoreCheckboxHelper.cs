...
{
    /// <summary>
    /// Smi-override-store-checkbox tag helper
    /// </summary>
    [HtmlTargetElement("Smi-override-store-checkbox", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class SmiOverrideStoreCheckboxHelper : TagHelper
    {
        ...
        public SmiOverrideStoreCheckboxHelper(IHtmlHelper htmlHelper)
        {
