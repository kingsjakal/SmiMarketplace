...
namespace Smi.Web.Framework.Themes
{
    /// <summary>
        ...
        public string WorkingThemeName
        {
            get
            {
                ...
                if (_storeInformationSettings.AllowCustomerToSelectTheme && _workContext.CurrentCustomer != null)
                {
                    themeName = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer,
                        SmiCustomerDefaults.WorkingThemeNameAttribute, _storeContext.CurrentStore.Id);
                }
            ...
            set
            {
                ...
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                    SmiCustomerDefaults.WorkingThemeNameAttribute, value, _storeContext.CurrentStore.Id);
