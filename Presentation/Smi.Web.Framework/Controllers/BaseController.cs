...
namespace Smi.Web.Framework.Controllers
{
    /// <summary>
    /// Base controller
    /// </summary>
    ...
    public abstract class BaseController : Controller
    {
        ...
        public virtual void SaveSelectedPanelName(string tabName, bool persistForTheNextRequest = true)
        {
            ...
            //"GetSelectedPanelName" method of \Smi.Web.Framework\Extensions\HtmlExtensions.cs
            if (string.IsNullOrEmpty(tabName))
                throw new ArgumentNullException(nameof(tabName));

            const string dataKey = "Smi.selected-panel-name";
        ...
        {
            //keep this method synchronized with
            //"GetSelectedTabName" method of \Smi.Web.Framework\Extensions\HtmlExtensions.cs
            if (string.IsNullOrEmpty(tabName))
            {
            ...
            var dataKey = "Smi.selected-tab-name";
