...
{
    /// <summary>
    /// Represents model binder for the binding models inherited from the BaseSmiModel
    /// </summary>
    public class SmiModelBinder : ComplexTypeModelBinder
    {
        #region Ctor
        ...
        public SmiModelBinder(IDictionary<ModelMetadata, IModelBinder> propertyBinders, ILoggerFactory loggerFactory)
        ...
        protected override object CreateModel(ModelBindingContext bindingContext)
        {
            ...
            if (model is BaseSmiModel)
                (model as BaseSmiModel).BindModel(bindingContext);
            ...
            ModelMetadata propertyMetadata, ModelBindingResult bindingResult)
        {
            ...
            //trim property string values for Smi models
            var valueAsString = bindingResult.Model as string;
            if (bindingContext.Model is BaseSmiModel && !string.IsNullOrEmpty(valueAsString))
            {
