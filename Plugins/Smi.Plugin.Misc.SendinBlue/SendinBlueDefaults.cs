...
namespace Smi.Plugin.Misc.SendinBlue
{
    /// <summary>
    ...
    public static class SendinBlueDefaults
    {
        ...
        /// </summary>
        public static string PartnerName => "SmiMarketplace";

        /// <summary>
        /// Gets a user agent used to request SendinBlue services
        /// </summary>
        public static string UserAgent => $"SmiMarketplace-{SmiVersion.CurrentVersion}";

        /// <summary>
        /// Gets a URL to edit message template on SendinBlue account
        /// </summary>
        public static string EditMessageTemplateUrl = "https://my.sendinblue.com/camp/template/{0}/message-setup?utm_source=SmiMarketplace_plugin&utm_medium=plugin&utm_campaign=module_link";
        ...
        /// </summary>
        public static string SynchronizationTask => "Smi.Plugin.Misc.SendinBlue.Services.SynchronizationTask";
        ...
        /// </summary>
        public static string OrderTotalSumServiceAttribute => "SmiMarketplace_CA_USER";

        /// <summary>
        /// Gets a name of attribute to store an order total sum of month
        /// </summary>
        public static string OrderTotalMonthSumServiceAttribute => "SmiMarketplace_LAST_30_DAYS_CA";

        /// <summary>
        /// Gets a name of attribute to store an order count
        /// </summary>
        public static string OrderCountServiceAttribute => "SmiMarketplace_ORDER_TOTAL";

        /// <summary>
        /// Gets a name of attribute to store all orders total sum
        /// </summary>
        public static string AllOrderTotalSumServiceAttribute => "SmiMarketplace_CA_TOTAL";

        /// <summary>
        /// Gets a name of attribute to store all orders total sum of month
        /// </summary>
        public static string AllOrderTotalMonthSumServiceAttribute => "SmiMarketplace_CA_LAST_30DAYS";

        /// <summary>
        /// Gets a name of attribute to store all orders count
        /// </summary>
        public static string AllOrderCountServiceAttribute => "SmiMarketplace_ORDERS_COUNT";
