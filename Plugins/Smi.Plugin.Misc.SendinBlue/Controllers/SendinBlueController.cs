...
using Smi.Plugin.Misc.SendinBlue.Models;
...
namespace Smi.Plugin.Misc.SendinBlue.Controllers
{
    ...
    public class SendinBlueController : BasePluginController
    {
        ...
        public IActionResult ImportContacts(BaseSmiModel model, IFormCollection form)
        {
            try
            {
                //logging info
