...
namespace Smi.Plugin.Shipping.FixedByWeightByTotal.Services
{
    /// <summary>
    ...
    public partial class ShippingByWeightByTotalService : IShippingByWeightByTotalService
    {
        ...
        /// </summary>
        private readonly CacheKey _shippingByWeightByTotalAllKey = new CacheKey("Smi.shippingbyweightbytotal.all", SHIPPINGBYWEIGHTBYTOTAL_PATTERN_KEY);
        private const string SHIPPINGBYWEIGHTBYTOTAL_PATTERN_KEY = "Smi.shippingbyweightbytotal.";
