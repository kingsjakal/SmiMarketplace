...
namespace Smi.Plugin.ExchangeRate.EcbExchange
{
    public class EcbExchangeRateProvider : BasePlugin, IExchangeRateProvider
    {
        ...
        public IList<Core.Domain.Directory.ExchangeRate> GetCurrencyLiveRates(string exchangeRateCurrencyCode)
        {
            ...
            try
            {
                var httpClient = _httpClientFactory.CreateClient(SmiHttpDefaults.DefaultHttpClient);
            ...
            if (exchangeRateCurrency == null)
                throw new SmiException(_localizationService.GetResource("Plugins.ExchangeRate.EcbExchange.Error"));
