...
namespace Smi.Plugin.Pickup.PickupInStore
{
    public class PickupInStoreProvider : BasePlugin, IPickupPointProvider
    {
        ...
        public GetPickupPointsResponse GetPickupPoints(Address address)
        {
            ...
            if (!result.PickupPoints.Any())
                result.AddError(_localizationService.GetResource("Plugins.Pickup.PickupInStore.SmiickupPoints"));
        ...
        public override void Install()
        {
            ...
            _localizationService.AddPluginLocaleResource(new Dictionary<string, string>
            {
                ...
                ["Plugins.Pickup.PickupInStore.SmiickupPoints"] = "No pickup points are available"
            });
