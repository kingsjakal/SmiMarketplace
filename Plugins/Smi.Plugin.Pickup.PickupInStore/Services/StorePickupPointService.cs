...
namespace Smi.Plugin.Pickup.PickupInStore.Services
{
    /// <summary>
    ...
    public partial class StorePickupPointService : IStorePickupPointService
    {
        ...
        /// {0} : current store ID
        /// </remarks>
        private readonly CacheKey _pickupPointAllKey = new CacheKey("Smi.pickuppoint.all-{0}");
        private const string PICKUP_POINT_PATTERN_KEY = "Smi.pickuppoint.";
