...
using Smi.Plugin.Widgets.NivoSlider.Infrastructure.Cache;
using Smi.Plugin.Widgets.NivoSlider.Models;
using Smi.Services.Caching;
using Smi.Services.Configuration;
using Smi.Services.Media;
using Smi.Web.Framework.Components;

namespace Smi.Plugin.Widgets.NivoSlider.Components
{
    [ViewComponent(Name = "WidgetsNivoSlider")]
    public class WidgetsNivoSliderViewComponent : SmiViewComponent
    {
