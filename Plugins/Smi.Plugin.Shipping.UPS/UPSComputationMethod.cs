...
using System.Linq;
using Smi.Core;
using Smi.Plugin.Shipping.UPS.Domain;
...
namespace Smi.Plugin.Shipping.UPS
{
    /// <summary>
    ...
    public class UPSComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        public override void Install()
        {
            ...
            {
                ["Enums.Smi.Plugin.Shipping.UPS.PackingType.PackByDimensions"] = "Pack by dimensions",
                ["Enums.Smi.Plugin.Shipping.UPS.PackingType.PackByOneItemPerPackage"] = "Pack by one item per package",
                ["Enums.Smi.Plugin.Shipping.UPS.PackingType.PackByVolume"] = "Pack by volume",
        ...
        public override void Uninstall()
        {
            ...
            //locales
            _localizationService.DeletePluginLocaleResources("Enums.Smi.Plugin.Shipping.UPS");
