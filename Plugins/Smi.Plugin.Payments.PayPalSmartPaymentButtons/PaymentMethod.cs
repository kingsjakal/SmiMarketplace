...
namespace Smi.Plugin.Payments.PayPalSmartPaymentButtons
{
    /// <summary>
    ...
    public class PaymentMethod : BasePlugin, IPaymentMethod, IWidgetPlugin
    {
        ...
        public override void Install()
        {
            ...
            {
                ["Enums.Smi.Plugin.Payments.PayPalSmartPaymentButtons.Domain.PaymentType.Authorize"] = "Authorize",
                ["Enums.Smi.Plugin.Payments.PayPalSmartPaymentButtons.Domain.PaymentType.Capture"] = "Capture",
        ...
        public override void Uninstall()
        {
            ...
            //locales
            _localizationService.DeletePluginLocaleResources("Enums.Smi.Plugin.Payments.PayPalSmartPaymentButtons");
