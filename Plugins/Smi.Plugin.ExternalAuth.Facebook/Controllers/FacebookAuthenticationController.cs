...
using Smi.Core;
using Smi.Plugin.ExternalAuth.Facebook.Models;
...
namespace Smi.Plugin.ExternalAuth.Facebook.Controllers
{
    public class FacebookAuthenticationController : BasePluginController
    {
        ...
        public IActionResult Login(string returnUrl)
        {
            ...
            if (!methodIsAvailable)
                throw new SmiException("Facebook authentication module cannot be loaded");
            ...
            {
                throw new SmiException("Facebook authentication module not configured");
            }
