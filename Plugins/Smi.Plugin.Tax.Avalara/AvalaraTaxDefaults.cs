...
namespace Smi.Plugin.Tax.Avalara
{
    ...
    public class AvalaraTaxDefaults
    {
        ...
        /// </summary>
        public static string ApplicationName => "SmiMarketplace-AvalaraTaxRateProvider|a0o33000004BoPM";

        /// <summary>
        /// Gets the Avalara tax provider version (used a SmiMarketplace version here)
        /// </summary>
        public static string ApplicationVersion => $"v{SmiVersion.CurrentVersion}";
        ...
        /// {7} - Zip postal code
        /// </remarks>
        public static CacheKey TaxRateCacheKey => new CacheKey("Smi.avalara.taxrate-{0}-{1}-{2}-{3}-{4}-{5}-{6}-{7}");

        /// <summary>
        /// Gets the key for caching Avalara tax code types
        /// </summary>
        public static CacheKey TaxCodeTypesCacheKey => new CacheKey("Smi.avalara.taxcodetypes");

        /// <summary>
        /// Gets the key for caching Avalara system entity use codes
        /// </summary>
        public static CacheKey EntityUseCodesCacheKey => new CacheKey("Smi.avalara.entityusecodes");
