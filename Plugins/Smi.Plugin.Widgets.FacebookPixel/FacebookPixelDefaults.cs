...
namespace Smi.Plugin.Widgets.FacebookPixel
{
    /// <summary>
    ...
    public class FacebookPixelDefaults
    {
        ...
        /// <summary>
        /// Gets the SmiMarketplace agent ID
        /// </summary>
        public static string AgentId => "plSmiMarketplace";
        ...
        /// </remarks>
        public static CacheKey ConfigurationCacheKey => new CacheKey("Smi.Plugin.Widgets.FacebookPixel.Configuration-{0}", PrefixCacheKey);
        ...
        /// {0} : store identifier
        /// </remarks>
        public static CacheKey ConfigurationsCacheKey => new CacheKey("Smi.Plugin.Widgets.FacebookPixel.Configurations-{0}", PrefixCacheKey);

        /// <summary>
        /// Gets the cache key for custom events
        /// </summary>
        public static CacheKey CustomEventsCacheKey => new CacheKey("Smi.Plugin.Widgets.FacebookPixel.CustomEvents-{0}", PrefixCacheKey);

        /// <summary>
        /// Gets the cache key for widget zones
        /// </summary>
        public static CacheKey WidgetZonesCacheKey => new CacheKey("Smi.Plugin.Widgets.FacebookPixel.WidgetZones", PrefixCacheKey);

        /// <summary>
        /// Gets the prefix key to clear cache
        /// </summary>
        public static string PrefixCacheKey => "Smi.Plugin.Widgets.FacebookPixel";
