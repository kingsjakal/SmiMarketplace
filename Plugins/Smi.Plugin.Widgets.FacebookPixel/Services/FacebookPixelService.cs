    ...
    public class FacebookPixelService
    {
        ...
        private string PrepareInitScript(IList<FacebookPixelConfiguration> configurations)
        {
            ...
            string getUserObject()
            {
                ...
                var firstName = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer, SmiCustomerDefaults.FirstNameAttribute);
                var lastName = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer, SmiCustomerDefaults.LastNameAttribute);
                var phone = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer, SmiCustomerDefaults.PhoneAttribute);
                var gender = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer, SmiCustomerDefaults.GenderAttribute);
                var birthday = _genericAttributeService.GetAttribute<DateTime?>(_workContext.CurrentCustomer, SmiCustomerDefaults.DateOfBirthAttribute);
                var city = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer, SmiCustomerDefaults.CityAttribute);
                var countryId = _genericAttributeService.GetAttribute<int>(_workContext.CurrentCustomer, SmiCustomerDefaults.CountryIdAttribute);
                var countryName = _countryService.GetCountryById(countryId)?.TwoLetterIsoCode;
                var stateId = _genericAttributeService.GetAttribute<int>(_workContext.CurrentCustomer, SmiCustomerDefaults.StateProvinceIdAttribute);
                var stateName = _stateProvinceService.GetStateProvinceById(stateId)?.Abbreviation;
                var zipcode = _genericAttributeService.GetAttribute<string>(_workContext.CurrentCustomer, SmiCustomerDefaults.ZipPostalCodeAttribute);
            ...
            return HandleFunction(() =>
            {
                ...
                var configurations = GetConfigurations(_storeContext.CurrentStore.Id).Where(configuration =>
                {
                    ...
                    var cookieConsentAccepted = _genericAttributeService.GetAttribute<bool>(_workContext.CurrentCustomer,
                            SmiCustomerDefaults.EuCookieLawAcceptedAttribute, _storeContext.CurrentStore.Id);
