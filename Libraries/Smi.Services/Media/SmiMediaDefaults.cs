...
namespace Smi.Services.Media
{
    ...
    /// </summary>
    public static partial class SmiMediaDefaults
    {
        /// <summary>
        ...
        /// {0} : thumb file name
        /// </remarks>
        public static CacheKey ThumbExistsCacheKey => new CacheKey("Smi.azure.thumb.exists-{0}", ThumbsExistsPrefixCacheKey);

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string ThumbsExistsPrefixCacheKey => "Smi.azure.thumb.exists";
