...
namespace Smi.Services.Common
{
    ...
    public partial class MaintenanceService : IMaintenanceService
    {
        ...
        {
            var path = _fileProvider.GetAbsolutePath(SmiCommonDefaults.DbBackupsPath);
        ...
        {
            return _fileProvider.Combine(GetBackupDirectoryPath(), $"database_{DateTime.Now:yyyy-MM-dd-HH-mm-ss}_{CommonHelper.GenerateRandomDigitCode(10)}.{SmiCommonDefaults.DbBackupFileExtension}");
        }
