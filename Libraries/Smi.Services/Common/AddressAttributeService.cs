...
namespace Smi.Services.Common
{
    ...
    public partial class AddressAttributeService : IAddressAttributeService
    {
        ...
        public virtual IList<AddressAttribute> GetAllAddressAttributes()
        {
            ...
            return query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiCommonDefaults.AddressAttributesAllCacheKey));
        }
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCommonDefaults.AddressAttributeValuesAllCacheKey, addressAttributeId);
