...
namespace Smi.Services.Tasks
{
    ...
    public partial class TaskThread : IDisposable
    {
        ...
        static TaskThread()
        {
            _scheduleTaskUrl = $"{EngineContext.Current.Resolve<IStoreContext>().CurrentStore.Url}{SmiTaskDefaults.ScheduleTaskPath}";
        ...
        private void Run()
        {
            ...
            foreach (var taskName in _tasks.Keys)
            {
                ...
                try
                {
                    ...
                    client = EngineContext.Current.Resolve<IHttpClientFactory>().CreateClient(SmiHttpDefaults.DefaultHttpClient);
