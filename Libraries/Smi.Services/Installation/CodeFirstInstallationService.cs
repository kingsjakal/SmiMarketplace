...
namespace Smi.Services.Installation
{
    /// <summary>
    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        private readonly ISmiDataProvider _dataProvider;
        private readonly IGenericAttributeService _genericAttributeService;
        private readonly ISmiFileProvider _fileProvider;
        ...
        {
            //duplicate of ValidateSeName method of \Smi.Services\Seo\UrlRecordService.cs (we cannot inject it here)
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));

            //validation
            var okChars = "abcdefghijklmSmiqrstuvwxyz1234567890 _-";
            ...
            //max length
            seName = CommonHelper.EnsureMaximumLength(seName, SmiSeoDefaults.SearchEngineNameLength);
        ...
        {
            return _fileProvider.GetAbsolutePath(SmiInstallationDefaults.SampleImagesPath);
        }
        ...
        protected virtual void InstallLocaleResources()
        {
            ...
            //save resources
            var directoryPath = _fileProvider.MapPath(SmiInstallationDefaults.LocalizationResourcesPath);
            var pattern = $"*.{SmiInstallationDefaults.LocalizationResourcesFileExtension}";
        ...
        protected virtual void InstallSampleCustomers()
        {
            var crRegistered = _customerRoleRepository.Table.FirstOrDefault(customerRole =>
                customerRole.SystemName == SmiCustomerDefaults.RegisteredRoleName);
            ...
            //second user
            var secondUserEmail = "steve_gates@SmiMarketplace.com";
            ...
            _genericAttributeService.SaveAttribute(secondUser, SmiCustomerDefaults.FirstNameAttribute, defaultSecondUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(secondUser, SmiCustomerDefaults.LastNameAttribute, defaultSecondUserAddress.LastName);
            ...
            //third user
            var thirdUserEmail = "arthur_holmes@SmiMarketplace.com";
            ...
            //set default customer name
            _genericAttributeService.SaveAttribute(thirdUser, SmiCustomerDefaults.FirstNameAttribute, defaultThirdUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(thirdUser, SmiCustomerDefaults.LastNameAttribute, defaultThirdUserAddress.LastName);
            ...
            //fourth user
            var fourthUserEmail = "james_pan@SmiMarketplace.com";
            ...
            //set default customer name
            _genericAttributeService.SaveAttribute(fourthUser, SmiCustomerDefaults.FirstNameAttribute, defaultFourthUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(fourthUser, SmiCustomerDefaults.LastNameAttribute, defaultFourthUserAddress.LastName);
            ...
            //fifth user
            var fifthUserEmail = "brenda_lindgren@SmiMarketplace.com";
            ...
            //set default customer name
            _genericAttributeService.SaveAttribute(fifthUser, SmiCustomerDefaults.FirstNameAttribute,
                defaultFifthUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(fifthUser, SmiCustomerDefaults.LastNameAttribute,
            ...
            //sixth user
            var sixthUserEmail = "victoria_victoria@SmiMarketplace.com";
            ...
            //set default customer name
            _genericAttributeService.SaveAttribute(sixthUser, SmiCustomerDefaults.FirstNameAttribute, defaultSixthUserAddress.FirstName);
            _genericAttributeService.SaveAttribute(sixthUser, SmiCustomerDefaults.LastNameAttribute, defaultSixthUserAddress.LastName);
        ...
        protected virtual void InstallCustomersAndUsers(string defaultUserEmail, string defaultUserPassword)
        {
            var crAdministrators = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = SmiCustomerDefaults.AdministratorsRoleName
            };
            var crForumModerators = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = SmiCustomerDefaults.ForumModeratorsRoleName
            };
            var crRegistered = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = SmiCustomerDefaults.RegisteredRoleName
            };
            var crGuests = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = SmiCustomerDefaults.GuestsRoleName
            };
            var crVendors = new CustomerRole
            {
                ...
                Active = true,
                IsSystemRole = true,
                SystemName = SmiCustomerDefaults.VendorsRoleName
            };
            ...
            //set default customer name
            _genericAttributeService.SaveAttribute(adminUser, SmiCustomerDefaults.FirstNameAttribute, "John");
            _genericAttributeService.SaveAttribute(adminUser, SmiCustomerDefaults.LastNameAttribute, "Smith");

            //set hashed admin password
            var customerRegistrationService = EngineContext.Current.Resolve<ICustomerRegistrationService>();
            customerRegistrationService.ChangePassword(new ChangePasswordRequest(defaultUserEmail, false,
                 PasswordFormat.Hashed, defaultUserPassword, null, SmiCustomerServicesDefaults.DefaultHashedPasswordFormat));
            ...
            var searchEngineUser = new Customer
            {
                ...
                SystemName = SmiCustomerDefaults.SearchEngineCustomerName,
                CreatedOnUtc = DateTime.UtcNow,
                LastActivityDateUtc = DateTime.UtcNow,
                RegisteredInStoreId = storeId
            };
            ...
            var backgroundTaskUser = new Customer
            {
                ...
                Active = true,
                IsSystemAccount = true,
                SystemName = SmiCustomerDefaults.BackgroundTaskCustomerName,
                CreatedOnUtc = DateTime.UtcNow,
                LastActivityDateUtc = DateTime.UtcNow,
                RegisteredInStoreId = storeId
            };
        ...
        protected virtual void InstallOrders()
        {
            ...
            //first order
            var firstCustomer = _customerRepository.Table.First(c => c.Email == "steve_gates@SmiMarketplace.com");
            ...
            var firstOrderItem3 = new OrderItem
            {
                ...
                PriceExclTax = 25M,
                OriginalProductCost = decimal.Zero,
                AttributeDescription = "From: Steve Gates &lt;steve_gates@SmiMarketplace.com&gt;<br />For: Brenda Lindgren &lt;brenda_lindgren@SmiMarketplace.com&gt;",
                AttributesXml = "<Attributes><GiftCardInfo><RecipientName>Brenda Lindgren</RecipientName><RecipientEmail>brenda_lindgren@SmiMarketplace.com</RecipientEmail><SenderName>Steve Gates</SenderName><SenderEmail>steve_gates@gmail.com</SenderEmail><Message></Message></GiftCardInfo></Attributes>",
                Quantity = 1,
                DiscountAmountInclTax = decimal.Zero,
                DiscountAmountExclTax = decimal.Zero,
                DownloadCount = 0,
            ...
            var firstOrderGiftcard = new GiftCard
            {
                ...
                RecipientEmail = "brenda_lindgren@SmiMarketplace.com",
                SenderName = "Steve Gates",
                SenderEmail = "steve_gates@SmiMarketplace.com",
            ...
            //second order
            var secondCustomer = _customerRepository.Table.First(c => c.Email == "arthur_holmes@SmiMarketplace.com");
            ...
            //third order
            var thirdCustomer = _customerRepository.Table.First(c => c.Email == "james_pan@SmiMarketplace.com");
            ...
            //fourth order
            var fourthCustomer = _customerRepository.Table.First(c => c.Email == "brenda_lindgren@SmiMarketplace.com");
            ...
            //fifth order
            var fifthCustomer = _customerRepository.Table.First(c => c.Email == "victoria_victoria@SmiMarketplace.com");
        ...
        protected virtual void InstallSettings()
        {
            ...
            settingService.SaveSetting(new CommonSettings
            {
                ...
                SupportPreviousSmiMarketplaceVersions = true,
            ...
            settingService.SaveSetting(new CatalogSettings
            {
                ...
                PageShareCode = "<!-- AddThis Button BEGIN --><div class=\"addthis_toolbox addthis_default_style \"><a class=\"addthis_button_preferred_1\"></a><a class=\"addthis_button_preferred_2\"></a><a class=\"addthis_button_preferred_3\"></a><a class=\"addthis_button_preferred_4\"></a><a class=\"addthis_button_compact\"></a><a class=\"addthis_counter addthis_bubble_style\"></a></div><script src=\"http://s7.addthis.com/js/250/addthis_widget.js#pubid=Smisolutions\"></script><!-- AddThis Button END -->",
            ...
            settingService.SaveSetting(new CustomerSettings
            {
                ...
                HashedPasswordFormat = SmiCustomerServicesDefaults.DefaultHashedPasswordFormat,
                PasswordMinLength = 6,
            ...
            settingService.SaveSetting(new StoreInformationSettings
            {
                ...
                FacebookLink = "https://www.facebook.com/SmiMarketplace",
                TwitterLink = "https://twitter.com/SmiMarketplace",
                YoutubeLink = "https://www.youtube.com/user/SmiMarketplace",
                HidePoweredBySmiMarketplace = false
            });
            ...
            settingService.SaveSetting(new CachingSettings
            {
                ...
                DefaultCacheTime = SmiCachingDefaults.CacheTime,
        ...
        protected virtual void InstallNews(string defaultUserEmail)
        {
            ...
            var news = new List<NewsItem>
            {
                new NewsItem
                {
                    AllowComments = true,
                    LanguageId = defaultLanguage.Id,
                    Title = "About SmiMarketplace",
                    Short = "It's stable and highly usable. From downloads to documentation, www.SmiMarketplace.com offers a comprehensive base of information, resources, and support to the SmiMarketplace community.",
                    Full = "<p>For full feature list go to <a href=\"https://www.SmiMarketplace.com\">SmiMarketplace.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow
                },
                new NewsItem
                {
                    AllowComments = true,
                    LanguageId = defaultLanguage.Id,
                    Title = "SmiMarketplace new release!",
                    Short = "SmiMarketplace includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included! SmiMarketplace is a fully customizable shopping cart",
                    Full = "<p>SmiMarketplace includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow.AddSeconds(1)
                },
                new NewsItem
                {
                    ...
                    Short = "The new SmiMarketplace store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site.",
        ...
        protected virtual void InstallPolls()
        {
            ...
            {
                LanguageId = defaultLanguage.Id,
                Name = "Do you like SmiMarketplace?",
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>
            {
                new ScheduleTask
                {
                    Name = "Send emails",
                    Seconds = 60,
                    Type = "Smi.Services.Messages.QueuedMessagesSendTask, Smi.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Keep alive",
                    Seconds = 300,
                    Type = "Smi.Services.Common.KeepAliveTask, Smi.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Delete guests",
                    Seconds = 600,
                    Type = "Smi.Services.Customers.DeleteGuestsTask, Smi.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Clear cache",
                    Seconds = 600,
                    Type = "Smi.Services.Caching.ClearCacheTask, Smi.Services",
                    Enabled = false,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "Smi.Services.Logging.ClearLogTask, Smi.Services",
                    Enabled = false,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "Smi.Services.Directory.UpdateExchangeRateTask, Smi.Services",
                    Enabled = true,
                    StopOnError = false
                }
            };
