...
namespace Smi.Services.Tax
{
    ...
    public partial class TaxService : ITaxService
    {
        ...
        protected virtual bool IsEuConsumer(Customer customer)
        {
            ...
            {
                var countryId = _genericAttributeService.GetAttribute<Customer, int>(customer.Id, SmiCustomerDefaults.CountryIdAttribute);
            ...
            var customerVatStatus = (VatNumberStatus)_genericAttributeService.GetAttribute<int>(customer, SmiCustomerDefaults.VatNumberStatusIdAttribute);
