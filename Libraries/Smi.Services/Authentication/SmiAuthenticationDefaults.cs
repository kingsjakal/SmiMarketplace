...
namespace Smi.Services.Authentication
{
    ...
    /// </summary>
    public static partial class SmiAuthenticationDefaults
    {
        /// <summary>
        ...
        /// </summary>
        public static string ClaimsIssuer => "SmiMarketplace";
        ...
        /// </summary>
        public static string ExternalAuthenticationErrorsSessionKey => "Smi.externalauth.errors";
    }
}