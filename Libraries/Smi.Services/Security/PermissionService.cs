...
namespace Smi.Services.Security
{
    ...
    public partial class PermissionService : IPermissionService
    {
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiSecurityDefaults.PermissionsAllByCustomerRoleIdCacheKey, customerRoleId);
        ...
        public virtual bool Authorize(string permissionRecordSystemName, int customerRoleId)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiSecurityDefaults.PermissionsAllowedCacheKey, permissionRecordSystemName, customerRoleId);
