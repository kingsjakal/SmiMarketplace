...
namespace Smi.Services.Discounts
{
    ...
    public partial class DiscountService : IDiscountService
    {
            ...
            DateTime? startDateUtc = null, DateTime? endDateUtc = null)
        {
            ...
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiDiscountDefaults.DiscountAllCacheKey
        ...
        public virtual DiscountValidationResult ValidateDiscount(Discount discount, Customer customer, string[] couponCodesToValidate)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiDiscountDefaults.DiscountRequirementModelCacheKey, discount);
