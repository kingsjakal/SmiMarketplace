...
namespace Smi.Services.Shipping.Date
{
    /// <summary>
    ...
    public partial class DateRangeService : IDateRangeService
    {
        ...
        public virtual IList<DeliveryDate> GetAllDeliveryDates()
        {
            var query = from dd in _deliveryDateRepository.Table
                        ...
                        select dd;
            var deliveryDates = query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiShippingDefaults.DeliveryDatesAllCacheKey));
        ...
        public virtual IList<ProductAvailabilityRange> GetAllProductAvailabilityRanges()
        {
            ...
            return query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiShippingDefaults.ProductAvailabilityAllCacheKey));
        }
