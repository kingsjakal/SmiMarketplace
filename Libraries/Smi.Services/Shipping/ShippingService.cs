...
namespace Smi.Services.Shipping
{
    ...
    public partial class ShippingService : IShippingService
    {
        ...
        public virtual IList<Warehouse> GetAllWarehouses(string name = null)
        {
            ...
            var warehouses = query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiShippingDefaults.WarehousesAllCacheKey));
            ...
            bool includeCheckoutAttributes = true, bool ignoreFreeShippedItems = false)
        {
            ...
            if (request.Customer is null || !includeCheckoutAttributes)
                return totalWeight;
            var checkoutAttributesXml = _genericAttributeService.GetAttribute<string>(request.Customer, SmiCustomerDefaults.CheckoutAttributes, _storeContext.CurrentStore.Id);
