...
namespace Smi.Services.ExportImport
{
    ...
    public partial class ImportManager : IImportManager
    {
        ...
        private string DownloadFile(string urlString, IList<string> downloadedFiles)
        {
            ...
            try
            {
                var client = _httpClientFactory.CreateClient(SmiHttpDefaults.DefaultHttpClient);
        ...
        public virtual void ImportProductsFromXlsx(Stream stream)
        {
            ...
            if (worksheet == null)
                throw new SmiException("No worksheet found");
            ...
            using (var reader = new StreamReader(stream))
            {
                while (!reader.EndOfStream)
                {
                    ...
                    else if (tmp.Length == 3)
                    {
                        ...
                        throw new SmiException("Wrong file format");
