...
namespace Smi.Services.Themes
{
    ...
    public partial class ThemeProvider : IThemeProvider
    {
        ...
        public IList<ThemeDescriptor> GetThemes()
        {
            ...
            var themeDirectoryPath = _fileProvider.MapPath(SmiPluginDefaults.ThemesPath);
            foreach (var descriptionFile in _fileProvider.GetFiles(themeDirectoryPath, SmiPluginDefaults.ThemeDescriptionFileName, false))
            {
