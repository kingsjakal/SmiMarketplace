...
namespace Smi.Services.Orders
{
    ...
    public partial class ReturnRequestService : IReturnRequestService
    {
        ...
        public virtual IList<ReturnRequestAction> GetAllReturnRequestActions()
        {
            ...
            return query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiOrderDefaults.ReturnRequestActionAllCacheKey));
        }
        ...
        public virtual IList<ReturnRequestReason> GetAllReturnRequestReasons()
        {
            ...
            return query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiOrderDefaults.ReturnRequestReasonAllCacheKey));
        }
