...
namespace Smi.Services.Messages
{
    ...
    public partial class NotificationService : INotificationService
    {
        ...
        protected virtual void PrepareTempData(NotifyType type, string message, bool encode = true)
        {
            ...
            var messages = tempData.ContainsKey(SmiMessageDefaults.NotificationListKey)
            ...
            tempData[SmiMessageDefaults.NotificationListKey] = JsonConvert.SerializeObject(messages);
        }
