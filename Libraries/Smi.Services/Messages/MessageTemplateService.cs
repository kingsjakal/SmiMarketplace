...
namespace Smi.Services.Messages
{
    ...
    public partial class MessageTemplateService : IMessageTemplateService
    {
        ...
        public virtual IList<MessageTemplate> GetMessageTemplatesByName(string messageTemplateName, int? storeId = null)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiMessageDefaults.MessageTemplatesByNameCacheKey, messageTemplateName, storeId);
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiMessageDefaults.MessageTemplatesAllCacheKey, storeId);
