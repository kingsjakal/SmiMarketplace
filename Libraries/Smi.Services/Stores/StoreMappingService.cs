...
namespace Smi.Services.Stores
{
    ...
    public partial class StoreMappingService : IStoreMappingService
    {
        ...
        public virtual IList<StoreMapping> GetStoreMappings<T>(T entity) where T : BaseEntity, IStoreMappingSupported
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiStoreDefaults.StoreMappingsByEntityIdNameCacheKey, entityId, entityName);
        ...
        public virtual int[] GetStoresIdsWithAccess<T>(T entity) where T : BaseEntity, IStoreMappingSupported
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiStoreDefaults.StoreMappingIdsByEntityIdNameCacheKey, entityId, entityName);
