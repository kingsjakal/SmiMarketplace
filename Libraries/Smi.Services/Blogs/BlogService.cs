...
namespace Smi.Services.Blogs
{
    ...
    public partial class BlogService : IBlogService
    {
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiBlogsDefaults.BlogTagsModelCacheKey, languageId, storeId, showHidden);
        ...
        public virtual int GetBlogCommentsCount(BlogPost blogPost, int storeId = 0, bool? isApproved = null)
        {
            ...
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiBlogsDefaults.BlogCommentsNumberCacheKey, blogPost, storeId, isApproved);
