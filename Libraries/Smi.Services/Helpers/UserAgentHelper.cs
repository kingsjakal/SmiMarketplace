...
namespace Smi.Services.Helpers
{
    /// <summary>
    /// User agent helper
    /// </summary>
    public partial class UserAgentHelper : IUserAgentHelper
    {
        ...
        protected virtual BrowscapXmlHelper GetBrowscapXmlHelper()
        {
            ...
            //no database created
            if (string.IsNullOrEmpty(_SmiConfig.UserAgentStringsPath))
                return null;
            ...
            lock (_locker)
            {
                ...
                var userAgentStringsPath = _fileProvider.MapPath(_SmiConfig.UserAgentStringsPath);
                var crawlerOnlyUserAgentStringsPath = !string.IsNullOrEmpty(_SmiConfig.CrawlerOnlyUserAgentStringsPath)
                    ? _fileProvider.MapPath(_SmiConfig.CrawlerOnlyUserAgentStringsPath)
                    : string.Empty;
        ...
        public virtual bool IsSearchEngine()
        {
            ...
            //more info: https://www.SmiMarketplace.com/boards/topic/17711/unhandled-exception-request-is-not-available-in-this-context
            try
            {
