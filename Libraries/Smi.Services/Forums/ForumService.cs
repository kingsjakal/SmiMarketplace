...
namespace Smi.Services.Forums
{
    ...
    public partial class ForumService : IForumService
    {
        ...
        private void UpdateCustomerStats(int customerId)
        {
            ...
            _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.ForumPostCountAttribute, numPosts);
        }
        ...
        public virtual IList<ForumGroup> GetAllForumGroups()
        {
            ...
            return query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiForumDefaults.ForumGroupAllCacheKey));
        }
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiForumDefaults.ForumAllByForumGroupIdCacheKey, forumGroupId);
        ...
        public virtual void InsertPrivateMessage(PrivateMessage privateMessage)
        {
            ...
            if (customerTo == null)
            {
                throw new SmiException("Recipient could not be loaded");
            }

            //UI notification
            _genericAttributeService.SaveAttribute(customerTo, SmiCustomerDefaults.NotifiedAboutNewPrivateMessagesAttribute, false, privateMessage.StoreId);
        ...
        public virtual string GetTopicSeName(ForumTopic forumTopic)
        {
            ...
            var maxLength = SmiSeoDefaults.ForumTopicLength;
