...
namespace Smi.Services.Topics
{
    ...
    public partial class TopicService : ITopicService
    {
        ...
        public virtual Topic GetTopicBySystemName(string systemName, int storeId = 0, bool showHidden = false)
        {
            ...
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiTopicDefaults.TopicBySystemNameCacheKey
        ...
        {
            var key = ignorAcl
                ? _cacheKeyService.PrepareKeyForDefaultCache(SmiTopicDefaults.TopicsAllCacheKey, storeId, showHidden,
                    onlyIncludedInTopMenu)
                : _cacheKeyService.PrepareKeyForDefaultCache(SmiTopicDefaults.TopicsAllWithACLCacheKey,
