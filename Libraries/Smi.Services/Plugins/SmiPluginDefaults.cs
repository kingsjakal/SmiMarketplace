...
namespace Smi.Services.Plugins
{
    ...
    /// </summary>
    public static partial class SmiPluginDefaults
    {
        /// <summary>
        ...
        /// </remarks>
        public static CacheKey AdminNavigationPluginsCacheKey => new CacheKey("Smi.plugins.adminnavigation-{0}", AdminNavigationPluginsPrefixCacheKey);

        /// <summary>
        /// Gets a key to clear cache
        /// </summary>
        public static string AdminNavigationPluginsPrefixCacheKey => "Smi.plugins.adminnavigation";
    }
}