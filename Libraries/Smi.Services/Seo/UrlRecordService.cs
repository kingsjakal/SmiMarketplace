...
namespace Smi.Services.Seo
{
    ...
    public partial class UrlRecordService : IUrlRecordService
    {
        ...
        public virtual IList<UrlRecord> GetUrlRecordsByIds(int[] urlRecordIds)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiSeoDefaults.UrlRecordByIdsCacheKey, urlRecordIds);
        ...
        public virtual UrlRecord GetBySlug(string slug)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiSeoDefaults.UrlRecordBySlugCacheKey, slug);
        ...
        public virtual IPagedList<UrlRecord> GetAllUrlRecords(string slug = "", int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            var urlRecords = query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiSeoDefaults.UrlRecordAllCacheKey));
        ...
        {
            //gradual loading
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiSeoDefaults.UrlRecordActiveByIdNameLanguageCacheKey, entityId, entityName, languageId);
