...
namespace Smi.Services.Seo
{
    ...
    /// </summary>
    public static partial class SmiSeoDefaults
    {
        /// <summary>
        ...
        /// </summary>
        public static CacheKey UrlRecordAllCacheKey => new CacheKey("Smi.urlrecord.all");
        ...
        /// {2} : language ID
        /// </remarks>
        public static CacheKey UrlRecordActiveByIdNameLanguageCacheKey => new CacheKey("Smi.urlrecord.active.id-name-language-{0}-{1}-{2}");
        ...
        /// {0} : IDs hash
        /// </remarks>
        public static CacheKey UrlRecordByIdsCacheKey => new CacheKey("Smi.urlrecord.byids-{0}", UrlRecordByIdsPrefixCacheKey);

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string UrlRecordByIdsPrefixCacheKey => "Smi.urlrecord.byids";
        ...
        /// {0} : slug
        /// </remarks>
        public static CacheKey UrlRecordBySlugCacheKey => new CacheKey("Smi.urlrecord.active.slug-{0}");
