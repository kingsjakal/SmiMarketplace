...
namespace Smi.Services.Catalog
{
    ...
    public partial class CategoryService : ICategoryService
    {
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.CategoriesAllCacheKey,
                storeId,
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.CategoriesByParentCategoryIdCacheKey,
        ...
        public virtual IList<Category> GetAllCategoriesDisplayedOnHomepage(bool showHidden = false)
        {
            ...
            var categories = query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.CategoriesAllDisplayedOnHomepageCacheKey));

            if (showHidden)
                return categories;

            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.CategoriesDisplayedOnHomepageWithoutHiddenCacheKey,
        ...
        public virtual IList<int> GetAppliedCategoryIds(Discount discount, Customer customer)
        {
            ...
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiDiscountDefaults.DiscountCategoryIdsModelCacheKey,
                discount,
        ...
        {
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.CategoriesChildIdentifiersCacheKey,
                parentCategoryId,
                _customerService.GetCustomerRoleIds(_workContext.CurrentCustomer),
                _storeContext.CurrentStore,
                showHidden);
            ...
            bool showHidden = false)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ProductCategoriesAllByProductIdCacheKey,
        ...
        public virtual IList<Category> GetCategoryBreadCrumb(Category category, IList<Category> allCategories = null, bool showHidden = false)
        {
            ...
            var breadcrumbCacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.CategoryBreadcrumbCacheKey,
                category,
                _customerService.GetCustomerRoleIds(_workContext.CurrentCustomer),
                _storeContext.CurrentStore,
