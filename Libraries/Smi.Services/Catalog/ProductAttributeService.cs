...
namespace Smi.Services.Catalog
{
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        {
            var allCacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ProductAttributeMappingsAllCacheKey, productId);
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ProductAttributeValuesAllCacheKey, productAttributeMappingId);
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.PredefinedProductAttributeValuesAllCacheKey, productAttributeId);
        ...
        public virtual IList<ProductAttributeCombination> GetAllProductAttributeCombinations(int productId)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ProductAttributeCombinationsAllCacheKey, productId);
