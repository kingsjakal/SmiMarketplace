    ...
    public partial class ReviewTypeService : IReviewTypeService
    {
        ...
        public virtual IList<ReviewType> GetAllReviewTypes()
        {
            return _reviewTypeRepository.Table
                ...
                .ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ReviewTypeAllCacheKey));
        }
        ...
        public IList<ProductReviewReviewTypeMapping> GetProductReviewReviewTypeMappingsByProductReviewId(
            int productReviewId)
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ProductReviewReviewTypeMappingAllCacheKey, productReviewId);
