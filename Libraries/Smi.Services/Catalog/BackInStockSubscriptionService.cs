...
namespace Smi.Services.Catalog
{
    ...
    public partial class BackInStockSubscriptionService : IBackInStockSubscriptionService
    {
        ...
        public virtual int SendNotificationsToSubscribers(Product product)
        {
            ...
            {
                var customerLanguageId = _genericAttributeService.GetAttribute<Customer, int>(subscription.CustomerId, SmiCustomerDefaults.LanguageIdAttribute, subscription.StoreId);
