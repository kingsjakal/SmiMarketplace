...
namespace Smi.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        protected readonly ISmiDataProvider _dataProvider;
        ...
        public virtual IList<Product> GetAllProductsDisplayedOnHomepage()
        {
            ...
            var products = query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ProductsAllDisplayedOnHomepageCacheKey));
        ...
        public virtual IList<Product> GetProductsByIds(int[] productIds)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ProductsByIdsCacheKey, productIds);
        ...
        public virtual int GetNumberOfProductsInCategory(IList<int> categoryIds = null, int storeId = 0)
        {
            ...
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.CategoryNumberOfProductsCacheKey,
        ...
        public virtual IList<RelatedProduct> GetRelatedProductsByProductId1(int productId, bool showHidden = false)
        {
            ...
            var relatedProducts = query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ProductsRelatedCacheKey, productId, showHidden));
        ...
        public virtual IList<TierPrice> GetTierPricesByProduct(int productId)
        {
            return _tierPriceRepository.Table.Where(tp => tp.ProductId == productId)
                .ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ProductTierPricesCacheKey, productId));
        }
