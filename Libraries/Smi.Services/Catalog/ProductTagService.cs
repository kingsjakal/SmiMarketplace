...
namespace Smi.Services.Catalog
{
    ...
    public partial class ProductTagService : IProductTagService
    {
        ...
        private Dictionary<int, int> GetProductCount(int storeId, bool showHidden)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ProductTagCountCacheKey, storeId, 
        ...
        public virtual IList<ProductTag> GetAllProductTags(string tagName = null)
        {
            ...
            var allProductTags = query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ProductTagAllCacheKey));
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ProductTagAllByProductIdCacheKey, productId);
        ...
        public virtual void UpdateProductTags(Product product, string[] productTags)
        {
            ...
            //cache
            _staticCacheManager.RemoveByPrefix(SmiCatalogDefaults.ProductTagPrefixCacheKey);
        }
