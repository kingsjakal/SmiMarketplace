...
namespace Smi.Services.Catalog
{
    ...
    public partial class SpecificationAttributeService : ISpecificationAttributeService
    {
        ...
        public virtual IList<SpecificationAttribute> GetSpecificationAttributesWithOptions()
        {
            ...
            return query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.SpecAttributesWithOptionsCacheKey));
        }
        ...
        public virtual IList<SpecificationAttributeOption> GetSpecificationAttributeOptionsBySpecificationAttribute(int specificationAttributeId)
        {
            ...
            var specificationAttributeOptions = query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.SpecAttributesOptionsCacheKey, specificationAttributeId));
            ...
            int specificationAttributeOptionId = 0, bool? allowFiltering = null, bool? showOnProductPage = null)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ProductSpecificationAttributeAllByProductIdCacheKey, 
