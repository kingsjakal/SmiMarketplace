...
namespace Smi.Services.Catalog
{
    ...
    public partial class ManufacturerService : IManufacturerService
    {
        ...
        public virtual IList<int> GetAppliedManufacturerIds(Discount discount, Customer customer)
        {
            ...
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(SmiDiscountDefaults.DiscountManufacturerIdsModelCacheKey, 
                discount,
            ...
            bool showHidden = false)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCatalogDefaults.ProductManufacturersAllByProductIdCacheKey, productId,
