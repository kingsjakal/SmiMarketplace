    ...
    public partial class VendorAttributeService : IVendorAttributeService
    {
        ...
        public virtual IList<VendorAttribute> GetAllVendorAttributes()
        {
            return _vendorAttributeRepository.Table
                ...
                .ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiVendorDefaults.VendorAttributesAllCacheKey));
        }
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiVendorDefaults.VendorAttributeValuesAllCacheKey, vendorAttributeId);
