...
namespace Smi.Services.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiDirectoryDefaults.CountriesAllCacheKey, languageId, showHidden);
        ...
        public virtual Country GetCountryByTwoLetterIsoCode(string twoLetterIsoCode)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiDirectoryDefaults.CountriesByTwoLetterCodeCacheKey, twoLetterIsoCode);
        ...
        public virtual Country GetCountryByThreeLetterIsoCode(string threeLetterIsoCode)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiDirectoryDefaults.CountriesByThreeLetterCodeCacheKey, threeLetterIsoCode);
