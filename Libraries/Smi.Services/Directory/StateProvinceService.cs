...
namespace Smi.Services.Directory
{
    ...
    public partial class StateProvinceService : IStateProvinceService
    {
        ...
        public virtual StateProvince GetStateProvinceByAbbreviation(string abbreviation, int? countryId = null)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiDirectoryDefaults.StateProvincesByAbbreviationCacheKey
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiDirectoryDefaults.StateProvincesByCountryCacheKey, countryId, languageId, showHidden);
        ...
        public virtual IList<StateProvince> GetStateProvinces(bool showHidden = false)
        {
            ...
            var stateProvinces = query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiDirectoryDefaults.StateProvincesAllCacheKey, showHidden));
