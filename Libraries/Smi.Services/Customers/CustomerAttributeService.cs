...
namespace Smi.Services.Customers
{
    ...
    public partial class CustomerAttributeService : ICustomerAttributeService
    {
        ...
        public virtual IList<CustomerAttribute> GetAllCustomerAttributes()
        {
            ...
            return query.ToCachedList(_cacheKeyService.PrepareKeyForDefaultCache(SmiCustomerServicesDefaults.CustomerAttributesAllCacheKey));
        }
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCustomerServicesDefaults.CustomerAttributeValuesAllCacheKey, customerAttributeId);
