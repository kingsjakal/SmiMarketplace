    ...
    public partial class CustomerService : ICustomerService
    {
            ...
            int pageIndex = 0, int pageSize = int.MaxValue, bool getOnlyTotalCount = false)
        {
            ...
            if (!string.IsNullOrWhiteSpace(firstName))
            {
                query = query
                    ...
                    .Where(z => z.Attribute.KeyGroup == nameof(Customer) &&
                                z.Attribute.Key == SmiCustomerDefaults.FirstNameAttribute &&
            ...
            if (!string.IsNullOrWhiteSpace(lastName))
            {
                query = query
                    .Join(_gaRepository.Table, x => x.Id, y => y.EntityId, (x, y) => new { Customer = x, Attribute = y })
                    .Where(z => z.Attribute.KeyGroup == nameof(Customer) &&
                                z.Attribute.Key == SmiCustomerDefaults.LastNameAttribute &&
            ...
            if (dayOfBirth > 0 && monthOfBirth > 0)
            {
                ...
                query = query
                    .Join(_gaRepository.Table, x => x.Id, y => y.EntityId, (x, y) => new { Customer = x, Attribute = y })
                    .Where(z => z.Attribute.KeyGroup == nameof(Customer) &&
                                z.Attribute.Key == SmiCustomerDefaults.DateOfBirthAttribute &&
            ...
            if (!string.IsNullOrWhiteSpace(company))
            {
                query = query
                    .Join(_gaRepository.Table, x => x.Id, y => y.EntityId, (x, y) => new { Customer = x, Attribute = y })
                    .Where(z => z.Attribute.KeyGroup == nameof(Customer) &&
                                z.Attribute.Key == SmiCustomerDefaults.CompanyAttribute &&
            ...
            if (!string.IsNullOrWhiteSpace(phone))
            {
                query = query
                    .Join(_gaRepository.Table, x => x.Id, y => y.EntityId, (x, y) => new { Customer = x, Attribute = y })
                    .Where(z => z.Attribute.KeyGroup == nameof(Customer) &&
                                z.Attribute.Key == SmiCustomerDefaults.PhoneAttribute &&
            ...
            if (!string.IsNullOrWhiteSpace(zipPostalCode))
            {
                query = query
                    .Join(_gaRepository.Table, x => x.Id, y => y.EntityId, (x, y) => new { Customer = x, Attribute = y })
                    .Where(z => z.Attribute.KeyGroup == nameof(Customer) &&
                                z.Attribute.Key == SmiCustomerDefaults.ZipPostalCodeAttribute &&
        ...
        public virtual void DeleteCustomer(Customer customer)
        {
            ...
            if (customer.IsSystemAccount)
                throw new SmiException($"System customer account ({customer.SystemName}) could not be deleted");
        ...
        {
            var backgroundTaskUser = GetCustomerBySystemName(SmiCustomerDefaults.BackgroundTaskCustomerName);
            ...
            if(backgroundTaskUser is null)
            {
                ...
                var guestRole = GetCustomerRoleBySystemName(SmiCustomerDefaults.GuestsRoleName);

                if(guestRole is null)
                    throw new SmiException("'Guests' role could not be loaded");
        ...
        {
            var searchEngineUser = GetCustomerBySystemName(SmiCustomerDefaults.SearchEngineCustomerName);
            ...
            bool clearPaymentMethod = true)
        {
            ...
            if (clearCouponCodes)
            {
                _genericAttributeService.SaveAttribute<string>(customer, SmiCustomerDefaults.DiscountCouponCodeAttribute, null);
                _genericAttributeService.SaveAttribute<string>(customer, SmiCustomerDefaults.GiftCardCouponCodesAttribute, null);
            }

            //clear checkout attributes
            if (clearCheckoutAttributes)
            {
                _genericAttributeService.SaveAttribute<string>(customer, SmiCustomerDefaults.CheckoutAttributes, null, storeId);
            }

            //clear reward points flag
            if (clearRewardPoints)
            {
                _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.UseRewardPointsDuringCheckoutAttribute, false, storeId);
            }

            //clear selected shipping method
            if (clearShippingMethod)
            {
                _genericAttributeService.SaveAttribute<ShippingOption>(customer, SmiCustomerDefaults.SelectedShippingOptionAttribute, null, storeId);
                _genericAttributeService.SaveAttribute<ShippingOption>(customer, SmiCustomerDefaults.OfferedShippingOptionsAttribute, null, storeId);
                _genericAttributeService.SaveAttribute<PickupPoint>(customer, SmiCustomerDefaults.SelectedPickupPointAttribute, null, storeId);
            }

            //clear selected payment method
            if (clearPaymentMethod)
            {
                _genericAttributeService.SaveAttribute<string>(customer, SmiCustomerDefaults.SelectedPaymentMethodAttribute, null, storeId);
            }
        ...
        public virtual string GetCustomerFullName(Customer customer)
        {
            ...
            var firstName = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.FirstNameAttribute);
            var lastName = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.LastNameAttribute);
        ...
        public virtual string FormatUsername(Customer customer, bool stripTooLong = false, int maxLength = 0)
        {
            ...
            switch (_customerSettings.CustomerNameFormat)
            {
                ...
                case CustomerNameFormat.ShowFirstName:
                    result = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.FirstNameAttribute);
                    break;
                default:
                    break;
            }
        ...
        public virtual string[] ParseAppliedDiscountCouponCodes(Customer customer)
        {
            ...
            var existingCouponCodes = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.DiscountCouponCodeAttribute);
        ...
        public virtual void ApplyDiscountCouponCode(Customer customer, string couponCode)
        {
            ...
            //apply new value
            _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.DiscountCouponCodeAttribute, result);
        }
        ...
        public virtual string[] ParseAppliedGiftCardCouponCodes(Customer customer)
        {
            ...
            var existingCouponCodes = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.GiftCardCouponCodesAttribute);
        ...
        public virtual void ApplyGiftCardCouponCode(Customer customer, string couponCode)
        {
            ...
            //apply new value
            _genericAttributeService.SaveAttribute(customer, SmiCustomerDefaults.GiftCardCouponCodesAttribute, result);
        }
        ...
        public virtual void DeleteCustomerRole(CustomerRole customerRole)
        {
            ...
            if (customerRole.IsSystemRole)
                throw new SmiException("System role could not be deleted");
        ...
        public virtual CustomerRole GetCustomerRoleBySystemName(string systemName)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCustomerServicesDefaults.CustomerRolesBySystemNameCacheKey, systemName);
        ...
        public virtual int[] GetCustomerRoleIds(Customer customer, bool showHidden = false)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForShortTermCache(SmiCustomerServicesDefaults.CustomerRoleIdsCacheKey, customer, showHidden);
        ...
        public virtual IList<CustomerRole> GetCustomerRoles(Customer customer, bool showHidden = false)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForShortTermCache(SmiCustomerServicesDefaults.CustomerRolesCacheKey, customer, showHidden);
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiCustomerServicesDefaults.CustomerRolesAllCacheKey, showHidden);
        ...
        {
            return IsInCustomerRole(customer, SmiCustomerDefaults.AdministratorsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, SmiCustomerDefaults.ForumModeratorsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, SmiCustomerDefaults.RegisteredRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, SmiCustomerDefaults.GuestsRoleName, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, SmiCustomerDefaults.VendorsRoleName, onlyActiveCustomerRoles);
        }
        ...
        public virtual bool IsPasswordRecoveryTokenValid(Customer customer, string token)
        {
            ...
            var cPrt = _genericAttributeService.GetAttribute<string>(customer, SmiCustomerDefaults.PasswordRecoveryTokenAttribute);
        ...
        public virtual bool IsPasswordRecoveryLinkExpired(Customer customer)
        {
            ...
            var geneatedDate = _genericAttributeService.GetAttribute<DateTime?>(customer, SmiCustomerDefaults.PasswordRecoveryTokenDateGeneratedAttribute);
        ...
        public virtual bool PasswordIsExpired(Customer customer)
        {
            ...
            var cacheKey = _cacheKeyService.PrepareKeyForShortTermCache(SmiCustomerServicesDefaults.CustomerPasswordLifetimeCacheKey, customer);
        ...
        public virtual IList<Address> GetAddressesByCustomerId(int customerId)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForShortTermCache(SmiCustomerServicesDefaults.CustomerAddressesByCustomerIdCacheKey, customerId);
        ...
        public virtual Address GetCustomerAddress(int customerId, int addressId)
        {
            ...
            var key = _cacheKeyService.PrepareKeyForShortTermCache(SmiCustomerServicesDefaults.CustomerAddressCacheKeyCacheKey, customerId, addressId);
