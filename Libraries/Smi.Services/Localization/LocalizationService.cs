...
namespace Smi.Services.Localization
{
    ...
    public partial class LocalizationService : ILocalizationService
    {
        ...
        {
            var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiLocalizationDefaults.LocaleStringResourcesAllCacheKey, languageId);
            ...
            if (!loadPublicLocales.HasValue || _staticCacheManager.IsSet(key))
            {
                ...
                _staticCacheManager.Remove(_cacheKeyService.PrepareKeyForDefaultCache(SmiLocalizationDefaults.LocaleStringResourcesAllPublicCacheKey, languageId));
                _staticCacheManager.Remove(_cacheKeyService.PrepareKeyForDefaultCache(SmiLocalizationDefaults.LocaleStringResourcesAllAdminCacheKey, languageId));
            ...
            key = _cacheKeyService.PrepareKeyForDefaultCache(
                    loadPublicLocales.Value ? SmiLocalizationDefaults.LocaleStringResourcesAllPublicCacheKey : SmiLocalizationDefaults.LocaleStringResourcesAllAdminCacheKey,
                    languageId);
            ...
            return _staticCacheManager.Get(key, () =>
            {
                ...
                var query = from l in _lsrRepository.Table
                            ...
                            where l.LanguageId == languageId
                            select l;
                query = loadPublicLocales.Value ? query.Where(r => !r.ResourceName.StartsWith(SmiLocalizationDefaults.AdminLocaleStringResourcesPrefix)) : query.Where(r => r.ResourceName.StartsWith(SmiLocalizationDefaults.AdminLocaleStringResourcesPrefix));
                return ResourceValuesToDictionary(query);
            });
        }
            ...
            bool logIfNotFound = true, string defaultValue = "", bool returnEmptyIfNotFound = false)
        {
            ...
            if (_localizationSettings.LoadAllLocaleRecordsOnStartup)
            {
                ...
                var resources = GetAllResourceValues(languageId, !resourceKey.StartsWith(SmiLocalizationDefaults.AdminLocaleStringResourcesPrefix, StringComparison.InvariantCultureIgnoreCase));
            ...
            {
                //gradual loading
                var key = _cacheKeyService.PrepareKeyForDefaultCache(SmiLocalizationDefaults.LocaleStringResourcesByResourceNameCacheKey
        ...
        public virtual string ExportResourcesToXml(Language language)
        {
            ...
            using (var xmlWriter = new XmlTextWriter(stream, Encoding.UTF8))
            {
                ...
                xmlWriter.WriteAttributeString("SupportedVersion", SmiVersion.CurrentVersion);
        ...
        public virtual void ImportResourcesFromXml(Language language, StreamReader xmlStreamReader, bool updateExistingResources = true)
        {
            ...
            //clear cache
            _staticCacheManager.RemoveByPrefix(SmiLocalizationDefaults.LocaleStringResourcesPrefixCacheKey);
        }
        ...
        public virtual string GetLocalizedEnum<TEnum>(TEnum enumValue, int? languageId = null) where TEnum : struct
        {
            ...
            //localized value
            var resourceName = $"{SmiLocalizationDefaults.EnumLocaleStringResourcesPrefix}{typeof(TEnum)}.{enumValue}";
        ...
        public virtual string GetLocalizedPermissionName(PermissionRecord permissionRecord, int? languageId = null)
        {
            ...
            //localized value
            var resourceName = $"{SmiLocalizationDefaults.PermissionLocaleStringResourcesPrefix}{permissionRecord.SystemName}";
            var result = GetResource(resourceName, languageId ?? _workContext.WorkingLanguage.Id, false, string.Empty, true);
            ...
            where TPlugin : IPlugin
        {
            ...
            //localized value
            var resourceName = $"{SmiLocalizationDefaults.PluginNameLocaleStringResourcesPrefix}{systemName}";
