...
namespace Smi.Data
{
    public class MySqlSmiDataProvider : BaseDataProvider, ISmiDataProvider
    {
        #region Fields
        ...
        public void InitializeDatabase()
        {
            ...
            ExecuteSqlScriptFromFile(fileProvider, SmiDataDefaults.MySQLStoredProceduresFilePath);
        }
