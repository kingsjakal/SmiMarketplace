...
using Smi.Core.Html.CodeFormatter;
using Smi.Core.Infrastructure;

namespace Smi.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                ...
                // format the URL tags: [url=https://www.SmiMarketplace.com]my site[/url]
                // becomes: <a href="https://www.SmiMarketplace.com">my site</a>
                text = regexUrl1.Replace(text, $"<a href=\"$1\" rel=\"nofollow\"{(newWindow ? " target=_blank" : "")}>$2</a>");

                // format the URL tags: [url]https://www.SmiMarketplace.com[/url]
                // becomes: <a href="https://www.SmiMarketplace.com">https://www.SmiMarketplace.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]https://www.SmiMarketplace.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="https://www.SmiMarketplace.com/Content/Images/Image.jpg">
