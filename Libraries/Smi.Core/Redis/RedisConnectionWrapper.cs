...
namespace Smi.Core.Redis
{
    ...
    public class RedisConnectionWrapper : IRedisConnectionWrapper, ILocker
    {
        ...
        public RedisConnectionWrapper(SmiConfig config)
        {
            _config = config;
        ...
        protected RedLockFactory CreateRedisLockFactory()
        {
            ...
            var configuratioSmitions = ConfigurationOptions.Parse(_connectionString.Value);
            var redLockEndPoints = GetEndPoints().Select(endPoint => new RedLockEndPoint
            {
                EndPoint = endPoint,
                Password = configuratioSmitions.Password,
                Ssl = configuratioSmitions.Ssl,
                RedisDatabase = configuratioSmitions.DefaultDatabase,
                ConfigCheckSeconds = configuratioSmitions.ConfigCheckSeconds,
                ConnectionTimeout = configuratioSmitions.ConnectTimeout,
                SyncTimeout = configuratioSmitions.SyncTimeout
            }).ToList();
