...
{
    /// <summary>
    /// A class that finds types needed by Smi by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected ISmiFileProvider _fileProvider;
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Smi.
        /// </returns>
        ...
        /// <summary>Gets or sets whether Smi should iterate assemblies in the app domain when loading Smi types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Smi assemblies aren't investigated (e.g. by not including something like "^Smi|..." you may break core functionality.</remarks>
