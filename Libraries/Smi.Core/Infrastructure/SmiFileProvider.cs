...
namespace Smi.Core.Infrastructure
{
    ...
    /// </summary>
    public class SmiFileProvider : PhysicalFileProvider, ISmiFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a SmiFileProvider
        /// </summary>
        /// <param name="webHostEnvironment">Hosting environment</param>
        public SmiFileProvider(IWebHostEnvironment webHostEnvironment)
