...
namespace Smi.Core.Domain.Common
{
    ...
    public class CommonSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether we should support previous SmiMarketplace versions (it can slightly improve performance)
        /// </summary>
        public bool SupportPreviousSmiMarketplaceVersions { get; set; }
