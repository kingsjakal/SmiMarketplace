...
namespace Smi.Core.Domain
{
    ...
    {
        /// <summary>
        /// Gets or sets a value indicating whether "powered by SmiMarketplace" text should be displayed.
        /// Please find more info at https://www.SmiMarketplace.com/SmiMarketplace-copyright-removal-key
        /// </summary>
        public bool HidePoweredBySmiMarketplace { get; set; }
