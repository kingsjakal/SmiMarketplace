...
namespace Smi.Core.Tests
{
    ...
    public class WebHelperTests
    {
        ...
        private Mock<ISmiFileProvider> _fileProvider;
        ...
        public void SetUp()
        {
            ...
            _fileProvider = new Mock<ISmiFileProvider>();
        ...
        {
            _httpContext.Request.PathBase = "/SmiMarketplacepath";
            _webHelper.GetStoreLocation(false).Should().Be("http://www.Example.com/SmiMarketplacepath/");
        }
        ...
        {
            _httpContext.Request.PathBase = "/SmiMarketplacepath";
            _webHelper.ModifyQueryString("/SmiMarketplacepath/Controller/Action", "param1", "value1").Should().Be("/SmiMarketplacepath/Controller/Action?param1=value1");
        }
    }
