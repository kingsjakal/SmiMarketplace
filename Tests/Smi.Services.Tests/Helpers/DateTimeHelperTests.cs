...
namespace Smi.Services.Tests.Helpers
{
    [TestFixture]
    public class DateTimeHelperTests : ServiceTest
    {
        ...
        public void Can_get_customer_timeZone_with_customTimeZones_enabled()
        {
            ...
            _genericAttributeService.Setup(x => x.GetAttribute<string>(customer, SmiCustomerDefaults.TimeZoneIdAttribute, 0, null))
                                ...
                                new GenericAttribute
                                    {
                                        ...
                                        Key = SmiCustomerDefaults.TimeZoneIdAttribute,
                                        KeyGroup = "Customer",
