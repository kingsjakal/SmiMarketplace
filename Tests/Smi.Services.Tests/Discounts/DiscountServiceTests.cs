...
namespace Smi.Services.Tests.Discounts
{
    [TestFixture]
    public class DiscountServiceTests : ServiceTest
    {
        ...
        public void Should_accept_valid_discount_code()
        {
            ...
            //we have to register "Smi_cache_static" cache manager (null manager) from DependencyRegistrar.cs
            //because DiscountService right now dynamically Resolve<ICacheManager>("Smi_cache_static")
