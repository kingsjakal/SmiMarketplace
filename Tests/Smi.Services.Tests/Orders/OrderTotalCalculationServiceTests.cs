...
using Smi.Services.Tests.FakeServices.Providers;
using Smi.Tests;
using NUnit.Framework;

namespace Smi.Services.Tests.Orders
{
    [TestFixture]
    public class OrderTotalCalculationServiceTests : ServiceTest
    {
        ...
        public OrderTotalCalculationServiceTests()
        {
            ...
            _genericAttributeService.Setup(x =>
                x.GetAttribute<PickupPoint>(It.IsAny<Customer>(), SmiCustomerDefaults.SelectedPickupPointAttribute, _storeContext.Object.CurrentStore.Id, null))
                .Returns(new PickupPoint());
            _genericAttributeService.Setup(x => x.GetAttribute<string>(It.IsAny<Customer>(), SmiCustomerDefaults.SelectedPaymentMethodAttribute, _storeContext.Object.CurrentStore.Id, null))
                .Returns("test1");
            ...
            SmiEngine.Setup(x => x.ResolveUnregistered(It.IsAny<Type>())).Returns((Type type) => Activator.CreateInstance(type));
